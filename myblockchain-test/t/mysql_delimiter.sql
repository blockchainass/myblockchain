...
# Test delimiter 'MyBlockchain'
select "Test delimiter MyBlockchain" as " ";
delimiter 'MyBlockchain'
select * from t1MyBlockchain
delimiter ; # Reset delimiter
...
#
source t/myblockchain_delimiter_source.sql
delimiter ; # Reset delimiter
...
#
source t/myblockchain_delimiter_19799.sql
use test//
show tables//
delimiter ; # Reset delimiter

#
# Bug #36244: MyBlockchain CLI doesn't recognize standalone -- as comment
