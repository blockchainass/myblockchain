 ...
 */
 ...
 ("Invalid \\(old\\?\\) table or blockchain name"),
 ...
 ("Slave: Can't drop blockchain.* blockchain doesn't exist"),
 ("Sort aborted"),
 ("Time-out in NDB"),
 ...
 (": The MyBlockchain server is running with the --secure-backup-file-priv option so it cannot execute this statement"),
 ...
 */
 ("Storing MyBlockchain user name or password information in the master.info repository is not secure.*"),
