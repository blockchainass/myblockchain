...
# Set myblockchain-test directory
my $myblockchain_test_dir= $ext_dir;
$myblockchain_test_dir =~ s/(\/|\\)suite(\/|\\)rpl(\/|\\)extension$//;
# Set path to mtr
my $mtr_script = File::Spec->catdir($myblockchain_test_dir, "myblockchain-test-run.pl");
# Set directory of rpl suite
my $suite_rpl_dir = File::Spec->catdir($myblockchain_test_dir, "suite", "rpl");
# Set directory of rpl_bhs suite
my $suite_rpl_bhs_dir = File::Spec->catdir($myblockchain_test_dir, "suite", "rpl_bhs");
...
{
    my $from_dir= File::Spec->catdir($myblockchain_test_dir, $cur_dir);
