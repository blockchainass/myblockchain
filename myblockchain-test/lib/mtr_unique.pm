# -*- cperl -*-
# Copyright (c) 2006, 2008 MyBlockchain AB, 2009 Sun Microsystems, Inc.
...
if(!IS_WINDOWS)
{
  $dir= "/tmp/myblockchain-unique-ids";
}
else
{
  ...
  {
    $dir= $ENV{'ALLUSERSPROFILE'}."/myblockchain-unique-ids";
  }
  else
  {
    $dir= $ENV{'TEMP'}."/myblockchain-unique-ids";
  }
}
