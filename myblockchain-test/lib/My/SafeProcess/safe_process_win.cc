...
/*
  ...
  To safeguard myblockchaind you would invoke safe_process with a few options
  ...
  $> safe_process --output=output.log -- myblockchaind --datadir=var/data1 ...

  This would redirect output to output.log and then start myblockchaind,
