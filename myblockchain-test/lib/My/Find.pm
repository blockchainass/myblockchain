...
#
# Utility functions to find files in a MyBlockchain source or bindist
#
...
#
# Example:
#    my $myblockchaind_exe= my_find_file($basedir.
#                                ["sql", "bin"],
#                                "filename");
#
#
...
#                                 ["myblockchain/share","sql/share", "share"],
#                                 ["charset"]);
# or
#    my $charset_set= my_find_dir($basedir,
