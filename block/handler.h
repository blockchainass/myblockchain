...
#include "key.h"               // KEY
#include "myblockchaind.h"            // lower_case_table_names
...
/* Bits in table_flags() to show what blockchain can do */
...
/*
    When a multiple key conflict happens in a REPLACE command myblockchain
    ...
    MyBlockchain expects the conflict with 'a' to be reported before the conflict with
    'b'.
...
static const uint MYBLOCKCHAIN_START_TRANS_OPT_WITH_CONS_SNAPSHOT = 1;
// READ ONLY option
static const uint MYBLOCKCHAIN_START_TRANS_OPT_READ_ONLY          = 2;
// READ WRITE option
static const uint MYBLOCKCHAIN_START_TRANS_OPT_READ_WRITE         = 4;
// HIGH PRIORITY option
static const uint MYBLOCKCHAIN_START_TRANS_OPT_HIGH_PRIORITY      = 8;
...
/*
  This is master blockchain for most of system tables. However there
  can be other blockchains which can hold system tables. Respective
  storage engines define their own system blockchain names.
*/
extern const char *myblockchaind_system_blockchain;

/*
  Structure to hold list of system_blockchain.system_table.
  This is used at both myblockchaind and storage engine layer.
*/
...
struct handlerton
{
  ...
  */
  ...
  /*
   ...
   slot number is initialized by MyBlockchain after xxx_init() is called.
   */
   uint slot;
   /*
   ...
   */
   ...
   /*
     ...
     this storage area - set it to something, so that MyBlockchain would know
   ...
   */
   ...
   void (*drop_blockchain)(handlerton *hton, char* path);
  ...
  */
  ...
  /**
    ...
    @note The referenced instance of HA_CREATE_INFO object was already
          ...
          has been processed by myblockchain_prepare_create_table() already.
  ...
  */
  ...
  /**
    ...
    @note Currently this array is produced as result of
          myblockchain_prepare_create_table() call.
...
#define CHF_INDEX_FLAG  3
  ...
  */
  ...
  /**
    ...
    refer to a different thread if called from myblockchain_lock_abort_for_thread().
...
private:
  ...
  */
  ...
  /**
    ...
    all columns of the row so MyBlockchain can create an error message. If
  ...
  */
  ...
  /**
    ...
    ::external_lock(F_UNLCK). If it is not, it is a bug in MyBlockchain.
  ...
  */
  ...
  /** admin commands - called from myblockchain_admin_table */
...
public:
  ...
  */
  ...
  /**
    ...
    return HA_ERR_WRONG_COMMAND and MyBlockchain will delete the rows one
    by one.
  */
  ...
  /**
    ...
    @remark This method is responsible for implementing MyBlockchain's TRUNCATE
...
extern MYBLOCKCHAIN_PLUGIN_IMPORT const char *tx_isolation_names[];
extern MYBLOCKCHAIN_PLUGIN_IMPORT const char *binlog_format_names[];
...
/**
  ...
  @note
    ...
    - no recovery (MyBlockchain did not detect a crash)
    in this case commit_list==0, tc_heuristic_recover == TC_HEURISTIC_NOT_USED
...
/* It is required by basic binlog features on both MyBlockchain server and libmyblockchaind */
