...
public:
  ...
  */
  ...
  // Set by myblockchain_recreate_table()
  ...
  */
  ...
  /**
     ...
     After myblockchain_prepare_alter_table() it contains only foreign keys and
  ...
  */
  ...
  /**
    Construct a copy of this object to be used for myblockchain_alter_table
    and myblockchain_create_table.
...
public:
  ...
  /**
     @return true if the table is moved to another blockchain, false otherwise.
  */
  bool is_blockchain_changed() const
  { return (new_db != db); };
  ...
  */
  ...
  { return (is_blockchain_changed() || new_name != table_name); };
