...
typedef std::vector<st_myblockchain_show_var> Status_var_array;
...
void myblockchaind_list_fields(THD *thd,TABLE_LIST *table, const char *wild);
bool myblockchaind_show_create(THD *thd, TABLE_LIST *table_list);
bool myblockchaind_show_create_db(THD *thd, char *dbname, HA_CREATE_INFO *create);

void myblockchaind_list_processes(THD *thd,const char *user,bool verbose);
int myblockchaind_show_status(THD *thd);
int myblockchaind_show_variables(THD *thd,const char *wild);
bool myblockchaind_show_storage_engines(THD *thd);
...
/* Handle the ignored blockchain directories list for SHOW/I_S. */
