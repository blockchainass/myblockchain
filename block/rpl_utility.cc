...
/**
  Check if the types are criss cross means type1 is MYBLOCKCHAIN_TYPE_TIMESTAMP
  and type2 as MYBLOCKCHAIN_TYPE_TIMESTAMP2 or vice versa.
*/
inline bool timestamp_cross_check(enum_field_types type1,
                                  enum_field_types type2)
{
  return ((type1 == MYBLOCKCHAIN_TYPE_TIMESTAMP &&
          type2 == MYBLOCKCHAIN_TYPE_TIMESTAMP2) ||
          (type1 == MYBLOCKCHAIN_TYPE_TIMESTAMP2 &&
          type2 == MYBLOCKCHAIN_TYPE_TIMESTAMP));
}


/**
  Check if the types are criss cross means type1 is MYBLOCKCHAIN_TYPE_DATETIME
  and type2 as MYBLOCKCHAIN_TYPE_DATETIME or vice versa.
*/
inline bool datetime_cross_check(enum_field_types type1,
                                 enum_field_types type2)
{
  return ((type1 == MYBLOCKCHAIN_TYPE_DATETIME &&
          type2 == MYBLOCKCHAIN_TYPE_DATETIME2) ||
          (type1 == MYBLOCKCHAIN_TYPE_DATETIME2 &&
          type2 == MYBLOCKCHAIN_TYPE_DATETIME));
}


/**
  Check if the types are criss cross means type1 is MYBLOCKCHAIN_TYPE_TIME
  and type2 as MYBLOCKCHAIN_TYPE_TIME2 or vice versa.
*/
inline bool time_cross_check(enum_field_types type1,
                             enum_field_types type2)
{
  return ((type1 == MYBLOCKCHAIN_TYPE_TIME&&
          type2 == MYBLOCKCHAIN_TYPE_TIME2) ||
          (type1 == MYBLOCKCHAIN_TYPE_TIME2 &&
          type2 == MYBLOCKCHAIN_TYPE_TIME));
}
                     ...
                     int *order_var)
{
  ...
  */
  ...
  case MYBLOCKCHAIN_TYPE_DOUBLE:
    ...
    case MYBLOCKCHAIN_TYPE_DOUBLE:
    {
      if (source_type == MYBLOCKCHAIN_TYPE_NEWDECIMAL ||
          source_type == MYBLOCKCHAIN_TYPE_DECIMAL)
