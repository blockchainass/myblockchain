  ...
  */
  ...
  else if (da->current_statement_cond_count())
  {
    ...
    /*
      ...
      In MyBlockchain most substantial warning is the last one.
...
bool sp_cursor::open(THD *thd)
{
  ...
  return myblockchain_open_cursor(thd, &m_result, &m_server_side_cursor);
}
