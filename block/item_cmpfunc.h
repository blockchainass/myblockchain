...
public:
  ...
  Item *create_item()
  {
    return new Item_temporal(MYBLOCKCHAIN_TYPE_DATETIME, 0LL);
  }
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);
};
...
public:
  ...
  Item *create_item()
  {
    return new Item_temporal(MYBLOCKCHAIN_TYPE_TIME, 0LL);
  }
  void set(uint pos, Item *item);
  uchar *get_value(Item *item);
};
...
public:
  ...
  Item* create_item()
  { 
    return new Item_temporal(MYBLOCKCHAIN_TYPE_DATETIME, (longlong) 0);
  }
};
...
/*
  ...
  in myblockchaind.h. The variables really belong in this component, but for
  the time being we leave them in myblockchaind.cc to avoid merge problems.
*/
