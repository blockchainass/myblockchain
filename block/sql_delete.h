...
bool myblockchain_prepare_delete(THD *thd);
bool myblockchain_delete(THD *thd, ha_rows rows);
int myblockchain_multi_delete_prepare(THD *thd, uint *table_count);
...
public:
  ...
  {
    // TODO: move the myblockchain_prepare_delete() call there
    return false;
  }
...
public:
  ...
  {
    uint table_count;
    return myblockchain_multi_delete_prepare(thd, &table_count);
  }
