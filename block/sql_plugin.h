...
#define MYBLOCKCHAIN_ANY_PLUGIN         -1
...
struct st_plugin_dl
{
  LEX_STRING dl;
  void *handle;
  struct st_myblockchain_plugin *plugins;
  int version;
...
public:
  ...
  /**
    ...
    myblockchain.plugin table, creating a cache entry and
...
public:
  ...
  /**
    ...
    myblockchain.plugin table, deleting a cache entry and
...
extern bool plugin_register_builtin(struct st_myblockchain_plugin *plugin);
