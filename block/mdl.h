...
public:
  ...
  */
  virtual void enter_cond(myblockchain_cond_t *cond, myblockchain_mutex_t *mutex,
...
/**
  ...
  E.g. They key for a table consists of <0 (=table)>+<blockchain>+<table name>.
...
public:
  ...
  /**
    ...
    Different types of objects exist in different namespaces
     ...
     - SCHEMA is for schemas (aka blockchains).
  ...
  */
  ...
  /**
    ...
    @remark The key for a table is <mdl_namespace>+<blockchain name>+<table name>
...
private:
  ...
  */
  myblockchain_mutex_t m_LOCK_wait_status;
  myblockchain_cond_t m_COND_wait_status;
...
private:
  ...
  */
  myblockchain_prlock_t m_LOCK_waiting_for;
  /**
...
public:
  ...
  void will_wait_for(MDL_wait_for_subgraph *waiting_for_arg)
  {
    ...
    */
    ...
    myblockchain_prlock_wrlock(&m_LOCK_waiting_for);
