...
bool Distinct_check::check_query(THD *thd)
{
       ...
       ++number_in_list, order= order->next)
  {
    ...
    /*
      ...
      position of the subquery in the query, MyBlockchain gives it a name or not; and
...
err:
  ...
  const char *text;
  /*
    Starting from MyBlockchain 5.7 we want give a better messages than before,
...
{
  /*
    Because the "fd" list is limited to columns and because MyBlockchain allows
