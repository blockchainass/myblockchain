...
#include "sql_base.h"       // MYBLOCKCHAIN_OPEN_IGNORE_FLUSH
...
void Rpl_info_table_access::before_open(THD *thd)
{
  ...
  m_flags= (MYBLOCKCHAIN_OPEN_IGNORE_GLOBAL_READ_LOCK |
            ...
            MYBLOCKCHAIN_LOCK_RPL_INFO_TABLE);

  /*
    This is equivalent to a new "statement". For that reason, we call both
    lex_start() and myblockchain_reset_thd_for_next_command.
  */
...
/**
  ...
  the myblockchaind startup, a thread is created in order to be able to
