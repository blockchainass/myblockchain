...
/*  
  This file provide myblockchain_string service to plugins.
  operations on myblockchain_string can be performed by plugins via these service
  functions.
*/
...
/*  
  This service function converts the myblockchain_string to the character set
...
/*  
  This service function deallocates the myblockchain_string_handle allocated on
  server and used in plugins.
*/
extern "C"
void myblockchain_string_free(myblockchain_string_handle string_handle)
{
  String *str= (String *) string_handle;
  str->mem_free();
  delete [] str;
...
/*  
  This service function deallocates the myblockchain_string_iterator_handle
  allocated on server and used in plugins.
*/
extern "C"
void myblockchain_string_iterator_free(myblockchain_string_iterator_handle iterator_handle)
{
  my_free((string_iterator *) iterator_handle);
}

/* This service function allocate myblockchain_string_iterator_handle and return it */
extern "C"
...
/* Provide service which returns the next myblockchain_string_iterator_handle */
extern "C"
...
*/
extern "C"
myblockchain_string_handle myblockchain_string_to_lowercase(myblockchain_string_handle string_handle)
{
  String *str= (String *) string_handle;
