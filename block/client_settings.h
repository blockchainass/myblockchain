...
/*
 Note: CLIENT_CAPABILITIES is also defined in libmyblockchain/client_settings.h.
 When adding capabilities here, consider if they should be also added to
 the libmyblockchain version.
*/
...
#define myblockchain_server_init(a,b,c) myblockchain_client_plugin_init()
#define myblockchain_server_end()       myblockchain_client_plugin_deinit()
