...
enum enum_condition_item_name
{
  ...
  */
  ...
  CIN_CURSOR_NAME= 9,
  CIN_MESSAGE_TEXT= 10,
  CIN_MYBLOCKCHAIN_ERRNO= 11,
  CIN_LAST_PROPERTY= CIN_MYBLOCKCHAIN_ERRNO
};
...
protected:
  ...
  */
  ...
  /**
    Assign the condition items 'MYBLOCKCHAIN_ERRNO', 'level' and 'MESSAGE_TEXT'
    default values of a condition.
    @param cond the condition to update.
    @param set_level_code true if 'level' and 'MYBLOCKCHAIN_ERRNO' needs to be overwritten
  ...
  */
  ...
  /**
    Evaluate the condition items 'SQLSTATE', 'MYBLOCKCHAIN_ERRNO', 'level' and 'MESSAGE_TEXT'
