...
#ifndef MYBLOCKCHAIND_INCLUDED
#define MYBLOCKCHAIND_INCLUDED

#include "my_global.h" /* MYBLOCKCHAIN_PLUGIN_IMPORT, FN_REFLEN, FN_EXTLEN */
#include "my_bitmap.h"                     /* MY_BITMAP */
#include "my_decimal.h"                         /* my_decimal */
#include "myblockchain_com.h"                     /* SERVER_VERSION_LENGTH */
...
extern "C" MYBLOCKCHAIN_PLUGIN_IMPORT CHARSET_INFO *system_charset_info;
extern MYBLOCKCHAIN_PLUGIN_IMPORT CHARSET_INFO *files_charset_info ;
extern MYBLOCKCHAIN_PLUGIN_IMPORT CHARSET_INFO *national_charset_info;
extern MYBLOCKCHAIN_PLUGIN_IMPORT CHARSET_INFO *table_alias_charset;
...
extern MYBLOCKCHAIN_PLUGIN_IMPORT bool volatile abort_loop;
...
extern my_bool check_proxy_users, myblockchain_native_password_proxy_users, sha256_password_proxy_users;
extern uint opt_crash_binlog_innodb;
extern char *shared_memory_base_name, *myblockchaind_unix_port;
...
extern uint protocol_version, myblockchaind_port, dropping_tables;
...
extern char *myblockchain_home_ptr, *pidfile_name_ptr;
extern char *default_auth_plugin;
extern uint default_password_lifetime;
extern char *my_bind_addr_str;
extern char glob_hostname[FN_REFLEN], myblockchain_home[FN_REFLEN];
...
extern MYBLOCKCHAIN_PLUGIN_IMPORT ulong max_connections;
...
extern "C" MYBLOCKCHAIN_PLUGIN_IMPORT ulong server_id;
extern time_t server_start_time, flush_status_time;
extern char *opt_myblockchain_tmpdir, myblockchain_charsets_dir[];
extern size_t myblockchain_unpacked_real_data_home_len;
extern MYBLOCKCHAIN_PLUGIN_IMPORT MY_TMPDIR myblockchain_tmpdir_list;
extern const char *show_comp_option_name[];
extern const char *first_keyword, *binary_keyword;
extern MYBLOCKCHAIN_PLUGIN_IMPORT const char  *my_localhost;
...
extern bool myblockchaind_server_started;
extern "C" MYBLOCKCHAIN_PLUGIN_IMPORT int orig_argc;
extern "C" MYBLOCKCHAIN_PLUGIN_IMPORT char **orig_argv;
...
/*
  ...
  using my_set_thread_local()/my_get_thread_local().
*/
extern MYBLOCKCHAIN_PLUGIN_IMPORT thread_local_key_t THR_THD;
...
extern PSI_memory_key key_memory_MYBLOCKCHAIN_LOCK;
extern PSI_memory_key key_memory_MYBLOCKCHAIN_LOG_name;
extern PSI_memory_key key_memory_TC_LOG_MMAP_pages;
extern PSI_memory_key key_memory_my_str_malloc;
extern PSI_memory_key key_memory_MYBLOCKCHAIN_BIN_LOG_basename;
extern PSI_memory_key key_memory_MYBLOCKCHAIN_BIN_LOG_index;
extern PSI_memory_key key_memory_MYBLOCKCHAIN_RELAY_LOG_basename;
extern PSI_memory_key key_memory_MYBLOCKCHAIN_RELAY_LOG_index;
...
extern MYBLOCKCHAIN_PLUGIN_IMPORT char reg_ext[FN_EXTLEN];
extern MYBLOCKCHAIN_PLUGIN_IMPORT uint reg_ext_length;
extern MYBLOCKCHAIN_PLUGIN_IMPORT uint lower_case_table_names;
extern MYBLOCKCHAIN_PLUGIN_IMPORT bool myblockchaind_embedded;

extern long tc_heuristic_recover;

extern ulong specialflag;
extern size_t myblockchain_data_home_len;
extern size_t myblockchain_real_data_home_len;
extern const char *myblockchain_real_data_home_ptr;
extern MYBLOCKCHAIN_PLUGIN_IMPORT char  *myblockchain_data_home;
extern "C" MYBLOCKCHAIN_PLUGIN_IMPORT char server_version[SERVER_VERSION_LENGTH];
extern MYBLOCKCHAIN_PLUGIN_IMPORT char myblockchain_real_data_home[];
extern char myblockchain_unpacked_real_data_home[];
extern MYBLOCKCHAIN_PLUGIN_IMPORT struct system_variables global_system_variables;
extern char default_logfile_name[FN_REFLEN];

#define myblockchain_tmpdir (my_tmpdir(&myblockchain_tmpdir_list))

extern MYBLOCKCHAIN_PLUGIN_IMPORT const key_map key_map_empty;
extern MYBLOCKCHAIN_PLUGIN_IMPORT key_map key_map_full;          /* Should be threaded as const */

/*
  Server mutex locks and condition variables.
 */
extern myblockchain_mutex_t
...
#ifdef HAVE_OPENSSL
extern myblockchain_mutex_t LOCK_des_key_file;
#endif
extern myblockchain_mutex_t LOCK_server_started;
extern myblockchain_cond_t COND_server_started;
extern myblockchain_mutex_t LOCK_reset_gtid_table;
extern myblockchain_mutex_t LOCK_compress_gtid_table;
extern myblockchain_cond_t COND_compress_gtid_table;
extern myblockchain_rwlock_t LOCK_sys_init_connect, LOCK_sys_init_slave;
extern myblockchain_rwlock_t LOCK_system_variables_hash;
extern myblockchain_cond_t COND_manager;
...
enum enum_query_type
{
  ...
  /// Don't print a blockchain if it's equal to the connection's blockchain
...
#if defined(MYBLOCKCHAIN_DYNAMIC_PLUGIN) && defined(_WIN32)
