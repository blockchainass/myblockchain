...
#include <myblockchain_com.h>  /* NAME_CHAR_LEN */
...
/*
  ...
  myblockchain.ndb_replication system table
...
/*
  ...
  This class represents a row in the myblockchain.ndb_replication table
*/
...
/**
   ...
   A helper class for accessing the myblockchain.ndb_replication
   table
*/
...
private:
  ...
  /**
     ...
     Checks that the schema of the myblockchain.ndb_replication table
     is acceptable.
     Returns
     0 if ok
...
public:
  ...
  /**
     ...
     lookup scans the myblockchain.ndb_replication table for
