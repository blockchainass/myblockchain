...
/* Total Number of ACLs present in myblockchain.user */
#define NUM_ACLS        29
...
/*
  ...
  3. myblockchain_system_tables.sql and myblockchain_system_tables_fix.sql
  4. acl_init() or whatever - to define behaviour for old privilege tables
  5. sql_yacc.yy - for GRANT/REVOKE to work
  6. auth_utils.h - for myblockchain_install_db
*/
