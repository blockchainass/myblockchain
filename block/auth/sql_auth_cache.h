...
#include "myblockchain_com.h"                  // SCRAMBLE_LENGTH
...
public:
  ...
  */
  ...
  MYBLOCKCHAIN_TIME password_last_changed;
...
class ACL_PROXY_USER :public ACL_ACCESS
{
  ...
  typedef enum { 
    MYBLOCKCHAIN_PROXIES_PRIV_HOST, 
    MYBLOCKCHAIN_PROXIES_PRIV_USER, 
    MYBLOCKCHAIN_PROXIES_PRIV_PROXIED_HOST,
    MYBLOCKCHAIN_PROXIES_PRIV_PROXIED_USER, 
    MYBLOCKCHAIN_PROXIES_PRIV_WITH_GRANT,
    MYBLOCKCHAIN_PROXIES_PRIV_GRANTOR,
    MYBLOCKCHAIN_PROXIES_PRIV_TIMESTAMP } old_acl_proxy_users;
public:
  ACL_PROXY_USER () {};
