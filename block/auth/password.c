...
/*****************************************************************************
  ...
  connection and that no password are saved in myblockchain in a decodable form.
  ...
  This is .c file because it's used in libmyblockchainclient, which is entirely in C.
...
/*
    MyBlockchain 4.1.1 password hashing: SHA conversion (see RFC 2289, 3174) twice
...
/*
  ...
  SYNOPSIS
    ...
    hash_stage2  hex2octet-decoded blockchain entry
    All params are IN.
