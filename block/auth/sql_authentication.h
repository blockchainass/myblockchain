...
#include <myblockchain/plugin_auth.h>          // MYBLOCKCHAIN_SERVER_AUTH_INFO
...
/**
  The internal version of what plugins know as MYBLOCKCHAIN_PLUGIN_VIO,
  basically the context of the authentication session
*/
struct MPVIO_EXT : public MYBLOCKCHAIN_PLUGIN_VIO
{
  MYBLOCKCHAIN_SERVER_AUTH_INFO auth_info;
