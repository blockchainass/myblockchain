...
public:
  ...
  virtual bool itemize(Parse_context *pc, Item **res)
  {
    ...
    /*
      ...
      - MyBlockchain native functions,
      - User Defined Functions,
      - Stored Functions (assuming the current <use> blockchain)
...
public:
  ...
  virtual bool itemize(Parse_context *pc, Item **res)
  {
    ...
    /*
      ...
      function version(),
      - MyBlockchain.version() is the SQL 2003 syntax for the native function
...
public:
  ...
  bool itemize(Parse_context *pc, Item **res)
  {
    ...
    */
    ...
    {
      enum_field_types type= MYBLOCKCHAIN_TYPE_STRING;
