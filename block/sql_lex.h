...
/**
  ...
  @note these codes are used when dealing with the myblockchain.proc system table, so
...
typedef struct st_lex_master_info
{
  ...
  */
  ...
  char *gtid;
  char* view_id;
  const char* channel;  // identifier similar to blockchain name
...
public:
  ...
  */
  ...
  /*
    ...
    explain_marker.
  */
  friend bool myblockchain_make_view(THD *thd, TABLE_SHARE *share, TABLE_LIST *table,
...
public:
  ...
  */
  ...
  /**
    ...
    @note in standard SQL, a query with HAVING is defined as grouped, however
          MyBlockchain allows HAVING without any aggregation to be the same as WHERE.
  */
  ...
  */
  ...
  /*
    This method created for reiniting LEX in myblockchain_admin_table() and can be
...
public:
  ...
  */
  ...
  /**
    ...
    NOTE: this member must be used within MYBLOCKCHAINlex() function only.
  */
...
extern int MYBLOCKCHAINlex(union YYSTYPE *yylval, struct YYLTYPE *yylloc,
                    class THD *thd);
