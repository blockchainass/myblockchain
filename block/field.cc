...
*/
#define FIELDTYPE_TEAR_FROM (MYBLOCKCHAIN_TYPE_BIT + 1)
#define FIELDTYPE_TEAR_TO   (MYBLOCKCHAIN_TYPE_JSON - 1)
...
static enum_field_types field_types_merge_rules [FIELDTYPE_NUM][FIELDTYPE_NUM]=
{
  ...
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_NEWDECIMAL,  MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_DECIMAL,     MYBLOCKCHAIN_TYPE_DECIMAL,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_JSON
    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NEWDECIMAL   MYBLOCKCHAIN_TYPE_ENUM
    MYBLOCKCHAIN_TYPE_NEWDECIMAL,  MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_SET          MYBLOCKCHAIN_TYPE_TINY_BLOB
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_TINY_BLOB,
  //MYBLOCKCHAIN_TYPE_MEDIUM_BLOB  MYBLOCKCHAIN_TYPE_LONG_BLOB
    MYBLOCKCHAIN_TYPE_MEDIUM_BLOB, MYBLOCKCHAIN_TYPE_LONG_BLOB,
  //MYBLOCKCHAIN_TYPE_BLOB         MYBLOCKCHAIN_TYPE_VAR_STRING
    MYBLOCKCHAIN_TYPE_BLOB,        MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_STRING       MYBLOCKCHAIN_TYPE_GEOMETRY
    MYBLOCKCHAIN_TYPE_STRING,      MYBLOCKCHAIN_TYPE_VARCHAR
  },
  /* MYBLOCKCHAIN_TYPE_TINY -> */
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_NEWDECIMAL,  MYBLOCKCHAIN_TYPE_TINY,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_SHORT,       MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_TINY,        MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_INT24,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_TINY,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  /* MYBLOCKCHAIN_TYPE_SHORT -> */
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_NEWDECIMAL,  MYBLOCKCHAIN_TYPE_SHORT,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_SHORT,       MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_SHORT,       MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_INT24,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_SHORT,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_NEWDECIMAL,  MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_LONG,        MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_DOUBLE,      MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_LONG,         MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_DOUBLE,      MYBLOCKCHAIN_TYPE_FLOAT,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_FLOAT,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_FLOAT,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_JSON
    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NEWDECIMAL   MYBLOCKCHAIN_TYPE_ENUM
    MYBLOCKCHAIN_TYPE_DOUBLE,      MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_SET          MYBLOCKCHAIN_TYPE_TINY_BLOB
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_TINY_BLOB,
  //MYBLOCKCHAIN_TYPE_MEDIUM_BLOB  MYBLOCKCHAIN_TYPE_LONG_BLOB
    MYBLOCKCHAIN_TYPE_MEDIUM_BLOB, MYBLOCKCHAIN_TYPE_LONG_BLOB,
  ...
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_NEWDATE,     MYBLOCKCHAIN_TYPE_TIME,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_DATETIME,    MYBLOCKCHAIN_TYPE_YEAR,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_NEWDATE,     MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_DATETIME,    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_DATETIME,    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_NEWDECIMAL,  MYBLOCKCHAIN_TYPE_LONGLONG,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_LONGLONG,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_DOUBLE,      MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_LONGLONG,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_NEWDATE,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  /* MYBLOCKCHAIN_TYPE_INT24 -> */
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_NEWDECIMAL,  MYBLOCKCHAIN_TYPE_INT24,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_INT24,       MYBLOCKCHAIN_TYPE_LONG,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_INT24,       MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_INT24,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_INT24,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_NEWDATE,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_NEWDATE,     MYBLOCKCHAIN_TYPE_DATETIME,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_NEWDATE,     MYBLOCKCHAIN_TYPE_DATETIME,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_TIME,        MYBLOCKCHAIN_TYPE_DATETIME,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_DATETIME,    MYBLOCKCHAIN_TYPE_TIME,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_DATETIME,    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_NEWDATE,     MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_FLOAT,       MYBLOCKCHAIN_TYPE_DOUBLE,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_YEAR,        MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_LONGLONG,    MYBLOCKCHAIN_TYPE_INT24,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_YEAR,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_BIT,         MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_JSON,        MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_NEWDECIMAL   MYBLOCKCHAIN_TYPE_ENUM
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_SET          MYBLOCKCHAIN_TYPE_TINY_BLOB
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_LONG_BLOB,
  //MYBLOCKCHAIN_TYPE_MEDIUM_BLOB  MYBLOCKCHAIN_TYPE_LONG_BLOB
    MYBLOCKCHAIN_TYPE_LONG_BLOB,   MYBLOCKCHAIN_TYPE_LONG_BLOB,
  //MYBLOCKCHAIN_TYPE_BLOB         MYBLOCKCHAIN_TYPE_VAR_STRING
    MYBLOCKCHAIN_TYPE_LONG_BLOB,   MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_STRING       MYBLOCKCHAIN_TYPE_GEOMETRY
    MYBLOCKCHAIN_TYPE_STRING,      MYBLOCKCHAIN_TYPE_VARCHAR
  },
  ...
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATETIME     MYBLOCKCHAIN_TYPE_YEAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_NEWDECIMAL,
  //MYBLOCKCHAIN_TYPE_NEWDATE      MYBLOCKCHAIN_TYPE_VARCHAR
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_BIT          <16>-<244>
    MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_ENUM,        MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_SET,         MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_TINY_BLOB,   MYBLOCKCHAIN_TYPE_TINY_BLOB,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_TINY_BLOB,   MYBLOCKCHAIN_TYPE_TINY_BLOB,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_TINY_BLOB,   MYBLOCKCHAIN_TYPE_TINY_BLOB,
  ...
  //MYBLOCKCHAIN_TYPE_MEDIUM_BLOB  MYBLOCKCHAIN_TYPE_LONG_BLOB
    MYBLOCKCHAIN_TYPE_MEDIUM_BLOB, MYBLOCKCHAIN_TYPE_LONG_BLOB,
  //MYBLOCKCHAIN_TYPE_BLOB         MYBLOCKCHAIN_TYPE_VAR_STRING
    MYBLOCKCHAIN_TYPE_BLOB,        MYBLOCKCHAIN_TYPE_TINY_BLOB,
  //MYBLOCKCHAIN_TYPE_STRING       MYBLOCKCHAIN_TYPE_GEOMETRY
    MYBLOCKCHAIN_TYPE_TINY_BLOB,   MYBLOCKCHAIN_TYPE_TINY_BLOB
  },
  ...
  {
  //MYBLOCKCHAIN_TYPE_DECIMAL      MYBLOCKCHAIN_TYPE_TINY
    MYBLOCKCHAIN_TYPE_MEDIUM_BLOB, MYBLOCKCHAIN_TYPE_MEDIUM_BLOB,
  //MYBLOCKCHAIN_TYPE_SHORT        MYBLOCKCHAIN_TYPE_LONG
    MYBLOCKCHAIN_TYPE_MEDIUM_BLOB, MYBLOCKCHAIN_TYPE_MEDIUM_BLOB,
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_MEDIUM_BLOB, MYBLOCKCHAIN_TYPE_MEDIUM_BLOB,
  ...
  //MYBLOCKCHAIN_TYPE_NEWDECIMAL   MYBLOCKCHAIN_TYPE_ENUM
    MYBLOCKCHAIN_TYPE_STRING,      MYBLOCKCHAIN_TYPE_STRING,
  //MYBLOCKCHAIN_TYPE_SET          MYBLOCKCHAIN_TYPE_TINY_BLOB
    MYBLOCKCHAIN_TYPE_STRING,      MYBLOCKCHAIN_TYPE_TINY_BLOB,
  //MYBLOCKCHAIN_TYPE_MEDIUM_BLOB  MYBLOCKCHAIN_TYPE_LONG_BLOB
    MYBLOCKCHAIN_TYPE_MEDIUM_BLOB, MYBLOCKCHAIN_TYPE_LONG_BLOB,
  //MYBLOCKCHAIN_TYPE_BLOB         MYBLOCKCHAIN_TYPE_VAR_STRING
    MYBLOCKCHAIN_TYPE_BLOB,        MYBLOCKCHAIN_TYPE_VARCHAR,
  ...
  //MYBLOCKCHAIN_TYPE_FLOAT        MYBLOCKCHAIN_TYPE_DOUBLE
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_NULL         MYBLOCKCHAIN_TYPE_TIMESTAMP
    MYBLOCKCHAIN_TYPE_GEOMETRY,    MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_LONGLONG     MYBLOCKCHAIN_TYPE_INT24
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
  //MYBLOCKCHAIN_TYPE_DATE         MYBLOCKCHAIN_TYPE_TIME
    MYBLOCKCHAIN_TYPE_VARCHAR,     MYBLOCKCHAIN_TYPE_VARCHAR,
...
/**
  ...
  to check the type of a non-Field in myblockchain_alter_table().
...
*/
type_conversion_status
Field_num::store_time(MYBLOCKCHAIN_TIME *ltime,
...
*/
type_conversion_status Field::check_constraints(int myblockchain_errno)
{
  /*
  ...
  */
  ...
  case CHECK_FIELD_WARN:
    set_warning(Sql_condition::SL_WARNING, myblockchain_errno, 1);
    /* fall through */
...
bool Field_num::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  DBUG_ASSERT(result_type() == INT_RESULT);
...
bool Field_num::get_time(MYBLOCKCHAIN_TIME *ltime)
{
  DBUG_ASSERT(result_type() == INT_RESULT);
...
uint Field::fill_cache_field(CACHE_FIELD *copy)
{
  ...
  if (flags & BLOB_FLAG)
  {
    ...
    return copy->length;
           ...
           (type() == MYBLOCKCHAIN_TYPE_STRING && copy->length >= 4 &&
            copy->length < 256))
  {
    copy->type= CACHE_STRIPPED;			    /* Remove end space */
    store_length= 2;
  }
  else if (type() ==  MYBLOCKCHAIN_TYPE_VARCHAR)
  {
...
bool Field::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
...
bool Field::get_time(MYBLOCKCHAIN_TIME *ltime)
{
  char buff[MAX_DATE_STRING_REP_LENGTH];
  String tmp(buff,sizeof(buff),&my_charset_bin),*res;
...
type_conversion_status Field::store_time(MYBLOCKCHAIN_TIME *ltime, uint8 dec_arg)
{
  ASSERT_COLUMN_MARKED_FOR_WRITE;
  char buff[MAX_DATE_STRING_REP_LENGTH];
...
type_conversion_status
Field_new_decimal::store_time(MYBLOCKCHAIN_TIME *ltime,
                                  uint8 dec_arg __attribute__((unused)))
{
  my_decimal decimal_value;
...
bool Field_new_decimal::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
...
bool Field_new_decimal::get_time(MYBLOCKCHAIN_TIME *ltime)
{
  my_decimal buf, *decimal_value= val_decimal(&buf);
  if (!decimal_value)
  {
...
type_conversion_status
Field_real::store_time(MYBLOCKCHAIN_TIME *ltime,
                       uint8 dec_arg __attribute__((unused)))
{
...
bool Field_real::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  return my_double_to_datetime_with_warn(val_real(), ltime, fuzzydate);
}


bool Field_real::get_time(MYBLOCKCHAIN_TIME *ltime)
{
...
Field_temporal::set_warnings(ErrConvString str, int warnings)
{
  ...
  if (warnings & MYBLOCKCHAIN_TIME_WARN_TRUNCATED)
  {
    set_datetime_warning(Sql_condition::SL_WARNING, WARN_DATA_TRUNCATED,
                         str, ts_type, !cut_incremented);
    cut_incremented= 1;
  }
  if (warnings & (MYBLOCKCHAIN_TIME_WARN_OUT_OF_RANGE | MYBLOCKCHAIN_TIME_WARN_ZERO_DATE |
                  MYBLOCKCHAIN_TIME_WARN_ZERO_IN_DATE))
  {
  ...
  if (warnings & MYBLOCKCHAIN_TIME_WARN_INVALID_TIMESTAMP)
  {
    set_datetime_warning(Sql_condition::SL_WARNING,
  ...
  if ((warnings & MYBLOCKCHAIN_TIME_NOTE_TRUNCATED) &&
...
type_conversion_status Field_temporal::store(longlong nr, bool unsigned_val)
{
  ...
  else
  {
    ...
    if (warnings & (MYBLOCKCHAIN_TIME_WARN_ZERO_DATE |
                    MYBLOCKCHAIN_TIME_WARN_ZERO_IN_DATE) &&
...
Field_temporal::store_lldiv_t(const lldiv_t *lld, int *warnings)
{
  ...
  {
    DBUG_ASSERT(warnings != 0); // Must be set by convert_number_to_TIME
    if (((*warnings & MYBLOCKCHAIN_TIME_WARN_ZERO_DATE) != 0 ||
         (*warnings & MYBLOCKCHAIN_TIME_WARN_ZERO_IN_DATE) != 0) &&
        !current_thd->is_strict_mode())
      error= TYPE_NOTE_TIME_TRUNCATED;
  }
...
Field_temporal::store(const char *str, size_t len, const CHARSET_INFO *cs)
{
  ...
  if (convert_str_to_TIME(str, len, cs, &ltime, &status))
  {
    ...
    */
    reset();
    if (status.warnings & (MYBLOCKCHAIN_TIME_WARN_ZERO_DATE |
                           MYBLOCKCHAIN_TIME_WARN_ZERO_IN_DATE) &&
        !current_thd->is_strict_mode())
      error= TYPE_NOTE_TIME_TRUNCATED;
    else
...
Field_temporal::convert_number_to_datetime(longlong nr, bool unsigned_val,
                                           MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
  /*
...
bool
Field_temporal_with_date::get_internal_check_zero(MYBLOCKCHAIN_TIME *ltime,
                                                 ...
                                                 int *warnings)
{
  ...
  if (ltime->time_type == MYBLOCKCHAIN_TIMESTAMP_DATE && nanoseconds)
  {
    *warnings|= MYBLOCKCHAIN_TIME_WARN_TRUNCATED;
...
type_conversion_status
Field_temporal_with_date::store_time(MYBLOCKCHAIN_TIME *ltime,
                                     uint8 dec_arg __attribute__((unused)))
{
  ASSERT_COLUMN_MARKED_FOR_WRITE;
  type_conversion_status error;
...
bool Field_temporal_with_date::send_binary(Protocol *protocol)
{
  ...
  if (get_date_internal(&ltime))
  {
    // Only MYBLOCKCHAIN_TYPE_TIMESTAMP can return an error in get_date_internal()
    DBUG_ASSERT(type() == MYBLOCKCHAIN_TYPE_TIMESTAMP);
    set_zero_time(&ltime, MYBLOCKCHAIN_TIMESTAMP_DATETIME);
  }
...
type_conversion_status
Field_temporal_with_date::store_internal_with_round(MYBLOCKCHAIN_TIME *ltime,
                                                    int *warnings)
{
...
/**
  ...
  blockchains. Such columns are replaced with their newer counterparts by CREATE
...
type_conversion_status
Field_timestamp::store_internal(const MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
  THD *thd= table ? table->in_use : current_thd;
  struct timeval tm;
...
*/
bool Field_timestamp::get_date_internal(MYBLOCKCHAIN_TIME *ltime)
{
  ASSERT_COLUMN_MARKED_FOR_READ;
  uint32 temp;
  THD  *thd= table ? table->in_use : current_thd;
...
bool Field_timestamp::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
...
type_conversion_status
Field_timestampf::store_internal(const MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
  THD *thd= table ? table->in_use : current_thd;
  struct timeval tm;
  convert_TIME_to_timestamp(thd, ltime, &tm, warnings);
...
bool Field_timestampf::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  /* Don't do check_fuzzy_date() as month and year are never 0 for timestamp */
  return get_internal_check_zero(ltime, fuzzydate);
}
...
bool
Field_timestampf::get_date_internal(MYBLOCKCHAIN_TIME *ltime)
{
  THD *thd= table ? table->in_use : current_thd;
  struct timeval tm;
...
type_conversion_status
Field_time_common::store_time(MYBLOCKCHAIN_TIME *ltime,
                              uint8 dec_arg __attribute__((unused)))
{
...
type_conversion_status
Field_time_common::store_internal_with_round(MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
...
bool Field_time_common::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  ASSERT_COLUMN_MARKED_FOR_READ;
...
{
  ASSERT_COLUMN_MARKED_FOR_READ;
  MYBLOCKCHAIN_TIME time, datetime;
  if (get_time(&time))
  {
...
type_conversion_status
Field_time::store_internal(const MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
...
bool Field_time::get_time(MYBLOCKCHAIN_TIME *ltime)
{
...
type_conversion_status
Field_timef::store_internal(const MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
  ...
  if (rc == TYPE_OK && non_zero_date(ltime))
  {
    ...
    */
    *warnings|= MYBLOCKCHAIN_TIME_NOTE_TRUNCATED;
...
bool Field_timef::get_time(MYBLOCKCHAIN_TIME *ltime)
{
...
type_conversion_status
Field_year::store_time(MYBLOCKCHAIN_TIME *ltime,
                       uint8 dec_arg __attribute__((unused)))
{
  if (ltime->time_type != MYBLOCKCHAIN_TIMESTAMP_DATETIME &&
...
type_conversion_status
Field_newdate::store_internal(const MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
...
bool Field_newdate::get_date_internal(MYBLOCKCHAIN_TIME *ltime)
{
...
bool Field_newdate::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  return get_internal_check_zero(ltime, fuzzydate) ||
...
{
  MYBLOCKCHAIN_TIME myblockchain_time;
  THD *thd= current_thd;
  thd->variables.time_zone->gmt_sec_to_TIME(&myblockchain_time, *tm);
  thd->time_zone_used= true;
  int error= 0;
  store_internal(&myblockchain_time, &error);
}
...
bool Field_datetime::get_date_internal(MYBLOCKCHAIN_TIME *ltime)
{
...
type_conversion_status
Field_datetime::store_internal(const MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
...
/*
  ...
  to avoid convertion from number to MYBLOCKCHAIN_TIME.
...
bool Field_datetime::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  return get_internal_check_zero(ltime, fuzzydate) ||
         check_fuzzy_date(ltime, fuzzydate);
}
...
void Field_datetimef::store_timestamp_internal(const timeval *tm)
{
  ...
  thd->time_zone_used= true;
  int warnings= 0;
  store_internal(&myblockchain_time, &warnings);
}



bool Field_datetimef::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  return get_internal_check_zero(ltime, fuzzydate) ||
         check_fuzzy_date(ltime, fuzzydate);
}
...
bool Field_datetimef::get_date_internal(MYBLOCKCHAIN_TIME *ltime)
{
...
type_conversion_status
Field_datetimef::store_internal(const MYBLOCKCHAIN_TIME *ltime, int *warnings)
{
...
check_field_for_37426(const void *param_arg)
{
  ...
  DBUG_ASSERT(param->field->real_type() == MYBLOCKCHAIN_TYPE_STRING);
...
{
  Field *field;
  if (type() != MYBLOCKCHAIN_TYPE_VAR_STRING || keep_type)
...
{
  DBUG_ASSERT(type() == MYBLOCKCHAIN_TYPE_JSON);
...
type_conversion_status Field_json::store_time(MYBLOCKCHAIN_TIME *ltime, uint8 dec_arg)
{
  return unsupported_conversion();
}
...
bool Field_json::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
...
bool Field_json::get_time(MYBLOCKCHAIN_TIME *ltime)
{
  ASSERT_COLUMN_MARKED_FOR_READ;
  ...
  if (result)
    set_zero_time(ltime, MYBLOCKCHAIN_TIMESTAMP_DATETIME); /* purecov: inspected */
  return result;
}
                        ...
                        Generated_column *fld_gcol_info)
{
  ...
  */
  ...
  case MYBLOCKCHAIN_TYPE_VARCHAR:
    /*
      Long VARCHAR's are automaticly converted to blobs in myblockchain_prepare_table
  ...
  case MYBLOCKCHAIN_TYPE_FLOAT:
    ...
    if (fld_length && !fld_decimals)
    {
      ...
      {
        sql_type= MYBLOCKCHAIN_TYPE_DOUBLE;
  ...
  case MYBLOCKCHAIN_TYPE_DATE:
    /* Old date type. */
    sql_type= MYBLOCKCHAIN_TYPE_NEWDATE;
    /* fall trough */
  ...
  case MYBLOCKCHAIN_TYPE_SET:
    {
      ...
      /*
        ...
        Real length will be set in myblockchain_prepare_table()
  ...
  case MYBLOCKCHAIN_TYPE_ENUM:
    {
      ...
      while ((tmp= it++))
        interval_list.push_back(tmp);
      length= 1; /* See comment for MYBLOCKCHAIN_TYPE_SET above. */
      break;
   }
  case MYBLOCKCHAIN_TYPE_VAR_STRING:
    DBUG_ASSERT(0);  /* Impossible. */
  ...
  if (!(flags & BLOB_FLAG) &&
      ((length > max_field_charlength && fld_type != MYBLOCKCHAIN_TYPE_SET &&
        fld_type != MYBLOCKCHAIN_TYPE_ENUM &&
        (fld_type != MYBLOCKCHAIN_TYPE_VARCHAR || fld_default_value)) ||
       ((length == 0) &&
        fld_type != MYBLOCKCHAIN_TYPE_STRING &&
        fld_type != MYBLOCKCHAIN_TYPE_VARCHAR && fld_type != MYBLOCKCHAIN_TYPE_GEOMETRY)))
  {
    my_error((fld_type == MYBLOCKCHAIN_TYPE_VAR_STRING ||
              fld_type == MYBLOCKCHAIN_TYPE_VARCHAR ||
              fld_type == MYBLOCKCHAIN_TYPE_STRING) ?  ER_TOO_BIG_FIELDLENGTH :
...
size_t calc_pack_length(enum_field_types type, size_t length)
{
  ...
  case MYBLOCKCHAIN_TYPE_VAR_STRING:
  case MYBLOCKCHAIN_TYPE_STRING:
  case MYBLOCKCHAIN_TYPE_DECIMAL:     return (length);
  case MYBLOCKCHAIN_TYPE_VARCHAR:     return (length + (length < 256 ? 1: 2));
  case MYBLOCKCHAIN_TYPE_YEAR:
  case MYBLOCKCHAIN_TYPE_TINY	: return 1;
  case MYBLOCKCHAIN_TYPE_SHORT : return 2;
  case MYBLOCKCHAIN_TYPE_INT24:
  case MYBLOCKCHAIN_TYPE_NEWDATE: return 3;
  case MYBLOCKCHAIN_TYPE_TIME: return 3;
  case MYBLOCKCHAIN_TYPE_TIME2:
    return length > MAX_TIME_WIDTH ?
           my_time_binary_length(length - MAX_TIME_WIDTH - 1) : 3;
  case MYBLOCKCHAIN_TYPE_TIMESTAMP: return 4;
  case MYBLOCKCHAIN_TYPE_TIMESTAMP2:
    return length > MAX_DATETIME_WIDTH ?
           my_timestamp_binary_length(length - MAX_DATETIME_WIDTH - 1) : 4;
  case MYBLOCKCHAIN_TYPE_DATE:
  case MYBLOCKCHAIN_TYPE_LONG	: return 4;
  case MYBLOCKCHAIN_TYPE_FLOAT : return sizeof(float);
  case MYBLOCKCHAIN_TYPE_DOUBLE: return sizeof(double);
  case MYBLOCKCHAIN_TYPE_DATETIME: return 8;
  case MYBLOCKCHAIN_TYPE_DATETIME2:
    return length > MAX_DATETIME_WIDTH ?
           my_datetime_binary_length(length - MAX_DATETIME_WIDTH - 1) : 5;
  case MYBLOCKCHAIN_TYPE_LONGLONG: return 8;	/* Don't crash if no longlong */
  case MYBLOCKCHAIN_TYPE_NULL	: return 0;
  case MYBLOCKCHAIN_TYPE_TINY_BLOB:	return 1+portable_sizeof_char_ptr;
  case MYBLOCKCHAIN_TYPE_BLOB:		return 2+portable_sizeof_char_ptr;
  case MYBLOCKCHAIN_TYPE_MEDIUM_BLOB:	return 3+portable_sizeof_char_ptr;
  case MYBLOCKCHAIN_TYPE_LONG_BLOB:	return 4+portable_sizeof_char_ptr;
  case MYBLOCKCHAIN_TYPE_GEOMETRY:	return 4+portable_sizeof_char_ptr;
  case MYBLOCKCHAIN_TYPE_JSON:         return 4+portable_sizeof_char_ptr;
  case MYBLOCKCHAIN_TYPE_SET:
  case MYBLOCKCHAIN_TYPE_ENUM:
  case MYBLOCKCHAIN_TYPE_NEWDECIMAL:
    abort(); return 0;                          // This shouldn't happen
  case MYBLOCKCHAIN_TYPE_BIT: return length / 8;
  default:
    return 0;
  }
}
...
{
  switch (type) {
    case 1: return f_settype((uint) MYBLOCKCHAIN_TYPE_TINY);
    case 2: return f_settype((uint) MYBLOCKCHAIN_TYPE_SHORT);
    case 3: return f_settype((uint) MYBLOCKCHAIN_TYPE_INT24);
    case 4: return f_settype((uint) MYBLOCKCHAIN_TYPE_LONG);
    case 8: return f_settype((uint) MYBLOCKCHAIN_TYPE_LONGLONG);
  }
		  ...
		  const char *field_name)
{
  ...
  if (f_is_alpha(pack_flag))
  {
    ...
    {
      if (field_type == MYBLOCKCHAIN_TYPE_STRING ||
          field_type == MYBLOCKCHAIN_TYPE_DECIMAL ||   // 3.23 or 4.0 string
          field_type == MYBLOCKCHAIN_TYPE_VAR_STRING)
        return new Field_string(ptr,field_length,null_pos,null_bit,
                                unireg_check, field_name,
                                field_charset);
      if (field_type == MYBLOCKCHAIN_TYPE_VARCHAR)
  ...
  stored_in_db(old_field->stored_in_db)
{
  ...
  case MYBLOCKCHAIN_TYPE_BLOB:
    ...
    case  1: sql_type= MYBLOCKCHAIN_TYPE_TINY_BLOB; break;
    case  2: sql_type= MYBLOCKCHAIN_TYPE_BLOB; break;
    case  3: sql_type= MYBLOCKCHAIN_TYPE_MEDIUM_BLOB; break;
    default: sql_type= MYBLOCKCHAIN_TYPE_LONG_BLOB; break;
    }
    length/= charset->mbmaxlen;
  ...
  case MYBLOCKCHAIN_TYPE_STRING:
    ...
    if (old_field->type() == MYBLOCKCHAIN_TYPE_VAR_STRING)
      sql_type= MYBLOCKCHAIN_TYPE_VARCHAR;
    /* fall through */
...
/**
  ...
  @param view_db_name     - if set this is the blockchain name for view
