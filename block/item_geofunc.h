...
public:
  ...
  enum_field_types field_type() const  { return MYBLOCKCHAIN_TYPE_GEOMETRY; }
...
/**
  ...
  coordinate dimension than MyBlockchain support should be handled. The function will
...
public:
  /**
    Describing how coordinate dimensions higher than supported in MyBlockchain
    should be handled.
  */
...
public:
  ...
  void fix_length_and_dec()
  {
    ...
    {
      if (args[i]->fixed && args[i]->field_type() != MYBLOCKCHAIN_TYPE_GEOMETRY)
      {
        String str;
