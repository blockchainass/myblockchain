...
#include "myblockchain_com.h"                          /* enum_field_types */
...
#define MYBLOCKCHAIN50_TABLE_NAME_PREFIX         "#myblockchain50#"
#define MYBLOCKCHAIN50_TABLE_NAME_PREFIX_LENGTH  9
...
bool myblockchain_create_table_no_lock(THD *thd, const char *db,
...
int myblockchain_discard_or_import_tablespace(THD *thd,
                                       ...
                                       bool discard);
bool myblockchain_prepare_alter_table(THD *thd, TABLE *table,
                               HA_CREATE_INFO *create_info,
                               Alter_info *alter_info,
...
bool myblockchain_create_like_table(THD *thd, TABLE_LIST *table,
                             TABLE_LIST *src_table,
                             HA_CREATE_INFO *create_info);
bool myblockchain_rename_table(handlerton *base, const char *old_db,
                        const char * old_name, const char *new_db,
                        const char * new_name, uint flags);

bool myblockchain_backup_table(THD* thd, TABLE_LIST* table_list);
bool myblockchain_restore_table(THD* thd, TABLE_LIST* table_list);

bool myblockchain_checksum_table(THD* thd, TABLE_LIST* table_list,
...
extern MYBLOCKCHAIN_PLUGIN_IMPORT const char *primary_key_name;
extern myblockchain_mutex_t LOCK_gdl;
