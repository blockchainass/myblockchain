...
/* Instrumentation key for performance schema for mts_temp_table_LOCK */
   ...
   */
  myblockchain_mutex_t mts_temp_table_LOCK;
  /*
  ...
  */
  myblockchain_mutex_t mts_gaq_LOCK;
  myblockchain_cond_t  logical_clock_cond;
  /*
  ...
  */
  MYBLOCKCHAIN_BIN_LOG relay_log;
  LOG_INFO linfo;
...
public:
  ...
  */
  ...
  myblockchain_mutex_t log_space_lock;
  myblockchain_cond_t log_space_cond;
  ...
  */
  ...
  HASH mapping_db_to_worker; // To map a blockchain to a worker
  bool inited_hash_workers; //  flag to check if mapping_db_to_worker is inited

  myblockchain_mutex_t slave_worker_hash_lock; // for mapping_db_to_worker
  myblockchain_cond_t  slave_worker_hash_cond;// for mapping_db_to_worker
  ...
  */
  ...
  myblockchain_mutex_t pending_jobs_lock;
  myblockchain_cond_t pending_jobs_cond;
  myblockchain_mutex_t exit_count_lock; // mutex of worker exit count
