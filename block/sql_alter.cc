...
#include "sql_table.h"                       // myblockchain_alter_table,
                                             // myblockchain_exchange_partition
...
bool Sql_cmd_alter_table::execute(THD *thd)
{
  ...
  /*
    Code in myblockchain_alter_table() may modify its HA_CREATE_INFO argument,
  ...
  */
  ...
  result= myblockchain_alter_table(thd, select_lex->db, lex->name.str,
...
bool Sql_cmd_discard_import_tablespace::execute(THD *thd)
{
  ...
  */
  ...
  /*
    Add current blockchain to the list of accessed blockchains
    for this statement. Needed for MTS.
  */
  thd->add_to_binlog_accessed_dbs(table_list->db);

  return
    myblockchain_discard_or_import_tablespace(thd, table_list,
