...
enum
{
  MYBLOCKCHAIN_PROC_FIELD_DB = 0,
  MYBLOCKCHAIN_PROC_FIELD_NAME,
  MYBLOCKCHAIN_PROC_MYBLOCKCHAIN_TYPE,
  MYBLOCKCHAIN_PROC_FIELD_SPECIFIC_NAME,
  MYBLOCKCHAIN_PROC_FIELD_LANGUAGE,
  MYBLOCKCHAIN_PROC_FIELD_ACCESS,
  MYBLOCKCHAIN_PROC_FIELD_DETERMINISTIC,
  MYBLOCKCHAIN_PROC_FIELD_SECURITY_TYPE,
  MYBLOCKCHAIN_PROC_FIELD_PARAM_LIST,
  MYBLOCKCHAIN_PROC_FIELD_RETURNS,
  MYBLOCKCHAIN_PROC_FIELD_BODY,
  MYBLOCKCHAIN_PROC_FIELD_DEFINER,
  MYBLOCKCHAIN_PROC_FIELD_CREATED,
  MYBLOCKCHAIN_PROC_FIELD_MODIFIED,
  MYBLOCKCHAIN_PROC_FIELD_SQL_MODE,
  MYBLOCKCHAIN_PROC_FIELD_COMMENT,
  MYBLOCKCHAIN_PROC_FIELD_CHARACTER_SET_CLIENT,
  MYBLOCKCHAIN_PROC_FIELD_COLLATION_CONNECTION,
  MYBLOCKCHAIN_PROC_FIELD_DB_COLLATION,
  MYBLOCKCHAIN_PROC_FIELD_BODY_UTF8,
  MYBLOCKCHAIN_PROC_FIELD_COUNT
};
...
/*
  Routines which allow open/lock and close myblockchain.proc table even when
