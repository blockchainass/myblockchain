...
/**
  ...
  type ::=
      ...
      0x0b |       // double
      0x0c |       // utf8mb4 string
      0x0f         // custom data (any MyBlockchain data type)
...
public:
  ...
  */
  ...
  Value()
    : m_type(ERROR), m_field_type(MYBLOCKCHAIN_TYPE_NULL), m_data(NULL),
...
private:
  ...
  /**
    The MyBlockchain field type of the value, in case the type of the value is
