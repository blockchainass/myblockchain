...
#endif
#define MAX_HOSTNAME  61			/* len+1 in myblockchain.user */
...
#ifndef MYBLOCKCHAIND_NET_RETRY_COUNT
#define MYBLOCKCHAIND_NET_RETRY_COUNT  10	///< Abort read after this many int.
#endif
...
/**
  ...
  char(64) in db). myblockchainbinlog needs it.
*/
...
/*
  Exit code used by myblockchaind_exit, exit and _exit function
  to indicate successful termination of myblockchaind.
*/
#define MYBLOCKCHAIND_SUCCESS_EXIT 0
/*
  Exit code used by myblockchaind_exit, exit and _exit function to
  signify unsuccessful termination of myblockchaind. The exit
  code signifies the server should NOT BE RESTARTED AUTOMATICALLY
  by init systems like systemd. 
*/
#define MYBLOCKCHAIND_ABORT_EXIT 1
/*
  Exit code used by myblockchaind_exit, exit and _exit function to
  signify unsuccessful termination of myblockchaind. The exit code
  signifies the server should be RESTARTED AUTOMATICALLY by
  init systems like systemd.
*/
#define MYBLOCKCHAIND_FAILURE_EXIT 2
