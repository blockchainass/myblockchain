...
#include "myblockchaind.h"     // opt_log_backward_compatible_user_definitions
...
static void myblockchain_rewrite_set(THD *thd, String *rlb)
{
  LEX                              *lex= thd->lex;
...
static void myblockchain_rewrite_change_master(THD *thd, String *rlb)
{
  LEX *lex= thd->lex;
...
static void myblockchain_rewrite_start_slave(THD *thd, String *rlb)
{
  LEX *lex= thd->lex;
...
static void myblockchain_rewrite_server_options(THD *thd, String *rlb)
{
  LEX *lex= thd->lex;
...
static void myblockchain_rewrite_create_server(THD *thd, String *rlb)
{
  LEX *lex= thd->lex;
  ...
  myblockchain_rewrite_server_options(thd, rlb);
}
...
static void myblockchain_rewrite_alter_server(THD *thd, String *rlb)
{
  LEX *lex= thd->lex;
...
static void myblockchain_rewrite_prepare(THD *thd, String *rlb)
{
  LEX *lex= thd->lex;
...
void myblockchain_rewrite_query(THD *thd)
{
  ...
  if (thd->lex->contains_plaintext_password)
  {
    ...
    {
    case SQLCOM_GRANT:         myblockchain_rewrite_grant(thd, rlb);         break;
    case SQLCOM_SET_OPTION:    myblockchain_rewrite_set(thd, rlb);           break;
    case SQLCOM_CREATE_USER:
    case SQLCOM_ALTER_USER:
                        myblockchain_rewrite_create_alter_user(thd, rlb);    break;
    case SQLCOM_CHANGE_MASTER: myblockchain_rewrite_change_master(thd, rlb); break;
    case SQLCOM_SLAVE_START:   myblockchain_rewrite_start_slave(thd, rlb);   break;
    case SQLCOM_CREATE_SERVER: myblockchain_rewrite_create_server(thd, rlb); break;
    case SQLCOM_ALTER_SERVER:  myblockchain_rewrite_alter_server(thd, rlb);  break;
    ...
    */
    case SQLCOM_PREPARE:       myblockchain_rewrite_prepare(thd, rlb);       break;
