...
@endverbatim
  ...
  @c myblockchain_execute_command(), or by
  ...
  opening the view (@c myblockchain_make_view()).
...
public:
  ...
  /**
     Helper to put the blockchain/table name in an object.
