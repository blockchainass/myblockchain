...
void myblockchaind_stmt_prepare(THD *thd, const char *query, uint length);
void myblockchaind_stmt_execute(THD *thd, ulong stmt_id, ulong flags, uchar *params,
                         ulong params_length);
void myblockchaind_stmt_close(THD *thd, ulong stmt_id);
void myblockchain_sql_stmt_prepare(THD *thd);
void myblockchain_sql_stmt_execute(THD *thd);
void myblockchain_sql_stmt_close(THD *thd);
void myblockchaind_stmt_fetch(THD *thd, ulong stmt_id, ulong num_rows);
void myblockchaind_stmt_reset(THD *thd, ulong stmt_id);
void myblockchain_stmt_get_longdata(THD *thd, ulong stmt_id, uint param_number,
...
public:
  ...
  */
  ...
  /**
    ...
    @sa Documentation for myblockchain_insert_id().
  */
  ...
  */
  ...
  { return m_diagnostics_area.myblockchain_errno(); }
