...
/*
  Injector to inject rows into the MyBlockchain server.
  
  The injector class is used to notify the MyBlockchain server of new rows that have
  appeared outside of MyBlockchain control.
  ...
  any manner that is outside of MyBlockchain server visibility and which therefore
  are not seen by the MyBlockchain server.
 */
class injector 
{
public:
  ...
  */
  static void free_instance();
    ...
    private:
      ...
      transaction(MYBLOCKCHAIN_BIN_LOG *, THD *);
