...
bool myblockchain_insert_select_prepare(THD *thd);
...
class Query_result_create: public Query_result_insert {
  ...
  MYBLOCKCHAIN_LOCK *m_lock;
  /* m_lock or thd->extra_lock */
  MYBLOCKCHAIN_LOCK **m_plock;
public:
...
protected:
  bool myblockchain_prepare_insert(THD *thd,
                            TABLE_LIST *table_list,
                            List_item *values,
                            bool select_insert);
  bool insert_precheck(THD *thd, TABLE_LIST *tables);
  bool myblockchain_prepare_insert_check_table(THD *thd,
                                        TABLE_LIST *table_list,
                                        List<Item> &fields,
                                        bool select_insert);
};
...
private:
  bool myblockchain_insert(THD *thd,TABLE_LIST *table);

  bool myblockchain_test_insert(THD *thd, TABLE_LIST *table_list);
};
