...
bool Item_singlerow_subselect::get_date(MYBLOCKCHAIN_TIME *ltime,
...
bool Item_singlerow_subselect::get_time(MYBLOCKCHAIN_TIME *ltime)
{
  if (!no_rows && !exec() && !value->null_value)
  {
    null_value= false;
...
void subselect_engine::set_row(List<Item> &item_list, Item_cache **row)
{
  ...
  res_field_type= MYBLOCKCHAIN_TYPE_VAR_STRING;
