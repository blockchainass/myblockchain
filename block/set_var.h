...
typedef enum enum_myblockchain_show_type SHOW_TYPE;
typedef enum enum_myblockchain_show_scope SHOW_SCOPE;
...
int myblockchain_add_sys_var_chain(sys_var *chain);
int myblockchain_del_sys_var_chain(sys_var *chain);
