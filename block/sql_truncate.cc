...
#include "lock.h"        // MYBLOCKCHAIN_OPEN_* flags
                                             ...
                                             bool is_tmp_table)
{
  ...
  */
  ...
  if (!is_tmp_table)
  {
    ...
    */
    flags= MYBLOCKCHAIN_OPEN_IGNORE_FLUSH;
    /*
      Even though we have an MDL lock on the table here, we don't
      pass MYBLOCKCHAIN_OPEN_HAS_MDL_LOCK to open_and_lock_tables
                                        ...
                                        bool *hton_can_recreate)
{
  ...
  /*
    ...
    MyBlockchain manual documents that TRUNCATE can be used to repair a
    damaged table, i.e. a table that can not be fully "opened".
    In particular MyBlockchain manual says: As long as the table format
