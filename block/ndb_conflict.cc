...
#ifdef HAVE_NDB_BINLOG
  /**
    WRITE_ROW to ndb_apply_status injected by MyBlockchainD
...
/**
   ...
   Properties
     ...
     5) The number of iterations of this loop is fixed to a hard coded limit, after
        ...
        blockchain between the two states, n times in a row.
                                 ...
                                 NdbInterpretedCode* code)
{
   ...
   * applied if the row in the blockchain was last written
...
int
show_ndb_conflict_status_vars(THD *thd, struct st_myblockchain_show_var *var, char *buff)
{
