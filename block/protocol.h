...
public:
  ...
  enum enum_protocol_type
  {
    ...
    */
    PROTOCOL_TEXT= 0,            // text Protocol type used mostly
                                 // for the old (MyBlockchain 4.0 protocol)
  ...
  */
  ...
  virtual bool store(MYBLOCKCHAIN_TIME *time, uint precision)= 0;
  virtual bool store_date(MYBLOCKCHAIN_TIME *time)= 0;
  virtual bool store_time(MYBLOCKCHAIN_TIME *time, uint precision)= 0;
  ...
  */
  ...
  /**
    ...
    The available capabilites are defined in myblockchain_com.h
  */
