    ...
    // Any characteristics to print?
    {
      /*
        ...
        c) A subsequent transaction started with START TRANSACTION
           (which is legal syntax in lieu of COMMIT AND CHAIN in MyBlockchain)
           ...
           - It may set up a read-only/read-write one-shot.
             ...
             reflect whatever behavior a given version of myblockchaind implements.
        ...
        given myblockchaind's actual behavior.
      */
