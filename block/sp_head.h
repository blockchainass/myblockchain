...
protected:
  Stored_program_creation_ctx(THD *thd)
    : Default_object_creation_ctx(thd),
      m_db_cl(thd->variables.collation_blockchain)
  { }
...
protected:
  ...
  {
    thd->variables.collation_blockchain= m_db_cl;
...
protected:
  /**
    db_cl stores the value of the blockchain collation. Both character set
  ...
  */
  ...
  /**
    ...
    @param[out] full_access  Set to 1 if the user has SELECT
                             to the 'myblockchain.proc' table or is
