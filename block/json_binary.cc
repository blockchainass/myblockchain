...
#include "json_dom.h"
#include "myblockchaind.h"             // key_memory_JSON
  ...
  case Json_dom::J_DECIMAL:
    {
      ...
      if (jd->get_binary(buf))
        return FAILURE;                       /* purecov: inspected */
      Json_opaque o(MYBLOCKCHAIN_TYPE_NEWDECIMAL, buf, bin_size);
...
/**
  Get the MyBlockchain field type of an opaque value. Identifies the type of
