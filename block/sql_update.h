...
bool myblockchain_update(THD *thd, List<Item> &fields,
...
public:
  ...
  virtual bool prepare(THD *thd) { return myblockchain_multi_update_prepare(thd); }
...
private:
  ...
  int myblockchain_multi_update_prepare(THD *thd);
  int myblockchain_test_update(THD *thd);
