  ...
  private:
    /*
      ...
      * statements that modified non-transactional tables. The value
      MODIFIED_NON_TRANS_TABLE is set within myblockchain_insert, myblockchain_update,
      myblockchain_delete, etc if a non-transactional table is modified.
...
public:
  /*
    ...
    ready_preempt in MYBLOCKCHAIN_BIN_LOG::ordered_commit.
  */
  struct
  {
    ...
    bool commit_low;                // see MYBLOCKCHAIN_BIN_LOG::ordered_commit
    bool run_hooks;                 // Call the after_commit hook
#ifndef DBUG_OFF
    bool ready_preempt;             // internal in MYBLOCKCHAIN_BIN_LOG::ordered_commit
#endif
  } m_flags;
