...
static int myblockchain_register_view(THD *thd, TABLE_LIST *view,
...
bool myblockchain_create_view(THD *thd, TABLE_LIST *views,
                       enum_view_create_mode mode)
{
  LEX *lex= thd->lex;
  bool link_to_local;
  ...
  bool res= FALSE;
  DBUG_ENTER("myblockchain_create_view");
  ...
  */
  ...
  /*
    Checking the existence of the blockchain in which the view is to be created
  */
  ...
  */
  ...
  res= myblockchain_register_view(thd, view, mode);
			       ...
			       enum_view_create_mode mode)
{
  ...
  */
  ...
  int error= 0;
  bool was_truncated;
  DBUG_ENTER("myblockchain_register_view");
...
/// RAII class to ease error handling in myblockchain_make_view()
...
*/
bool myblockchain_make_view(THD *thd, TABLE_SHARE *share, TABLE_LIST *view_ref,
                     bool open_view_no_parse)
{
  DBUG_ENTER("myblockchain_make_view");
  ...
  if (view_ref->is_view())
  {
    /*
      ...
      stored in MyBlockchain privilege system.  We don't need to restore the
  ...
  */
  ...
  /* 
    Use view db name as thread default blockchain, in order to ensure
    that the view is parsed and prepared correctly.
  */
  bool dbchanged;
  if ((result= myblockchain_opt_change_db(thd, view_ref->view_db, &old_db, 1,
                                   &dbchanged)))
    DBUG_RETURN(true);           /* purecov: inspected */
  ...
  /* switch off modes which can prevent normal parsing of VIEW
      ...
      * MODE_NO_UNSIGNED_SUBTRACTION  affect execution
      ...
      - MODE_MYBLOCKCHAIN323                 affect only SHOW
      - MODE_MYBLOCKCHAIN40                  affect only SHOW
  ...
  */
  ...
  if (dbchanged && myblockchain_change_db(thd, to_lex_cstring(old_db), true))
  {
    result= true;
    DBUG_RETURN(true);
  }
...
bool myblockchain_drop_view(THD *thd, TABLE_LIST *views, enum_drop_mode drop_mode)
{
  ...
  DBUG_ENTER("myblockchain_drop_view");
  ...
  */
  ...
  for (view= views; view; view= view->next_local)
  {
    ...
    if (myblockchain_file_delete(key_file_frm, path, MYF(MY_WME)))
      error= TRUE;
...
*/
bool
myblockchain_rename_view(THD *thd,
                  const char *new_db,
                  const char *new_name,
                  TABLE_LIST *view)
{
  ...
  bool error= TRUE;
  bool was_truncated;
  DBUG_ENTER("myblockchain_rename_view");
