...
public:
  ...
  */
  ...
  /**
     ...
     ready to be inserted into the myblockchain.servers table.
  ...
  */
  ...
  /**
     Create a record for updating a row in the myblockchain.servers table.
...
protected:
  ...
  /**
     Check permissions and open the myblockchain.servers table.
...
public:
  ...
  /**
     ...
     myblockchain.server table and creating a cache entry.
...
public:
  ...
  /**
     ...
     myblockchain.servers table and updating the cache entry.
...
public:
  ...
  /**
     ...
     myblockchain.servers table and removing the cache entry.
