...
public:
  ...
  */
  ...
  {
    if (field_type() == MYBLOCKCHAIN_TYPE_TIME)
  ...
  /**
    ...
    Before conversion from MYBLOCKCHAIN_TIME to packed format,
    the MYBLOCKCHAIN_TIME value is rounded to "dec" fractional digits.
  */
...
protected:
  ...
  */
  ...
  /**
    Convert val_str() to date in MYBLOCKCHAIN_TIME
  */
  bool get_date_from_string(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t flags);
  /**
    Convert val_real() to date in MYBLOCKCHAIN_TIME
  */
  bool get_date_from_real(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t flags);
  /**
    Convert val_decimal() to date in MYBLOCKCHAIN_TIME
  */
  bool get_date_from_decimal(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t flags);
  /**
    Convert val_int() to date in MYBLOCKCHAIN_TIME
  */
  bool get_date_from_int(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t flags);
  /**
    Convert get_time() from time to date in MYBLOCKCHAIN_TIME
  */
  bool get_date_from_time(MYBLOCKCHAIN_TIME *ltime);

  /**
    Convert a numeric type to date
  */
  bool get_date_from_numeric(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate);

  /**
    Convert a non-temporal type to date
  */
  bool get_date_from_non_temporal(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate);

  /**
    Convert val_str() to time in MYBLOCKCHAIN_TIME
  */
  bool get_time_from_string(MYBLOCKCHAIN_TIME *ltime);
  /**
    Convert val_real() to time in MYBLOCKCHAIN_TIME
  */
  bool get_time_from_real(MYBLOCKCHAIN_TIME *ltime);
  /**
    Convert val_decimal() to time in MYBLOCKCHAIN_TIME
  */
  bool get_time_from_decimal(MYBLOCKCHAIN_TIME *ltime);
  /**
    Convert val_int() to time in MYBLOCKCHAIN_TIME
  */
  bool get_time_from_int(MYBLOCKCHAIN_TIME *ltime);
  /**
    Convert date to time
  */
  bool get_time_from_date(MYBLOCKCHAIN_TIME *ltime);
  /**
    Convert datetime to time
  */
  bool get_time_from_datetime(MYBLOCKCHAIN_TIME *ltime);

  /**
    Convert a numeric type to time
  */
  bool get_time_from_numeric(MYBLOCKCHAIN_TIME *ltime);

  /**
    Convert a non-temporal type to time
  */
  bool get_time_from_non_temporal(MYBLOCKCHAIN_TIME *ltime);
...
public:
  ...
  */
  ...
  virtual bool get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)= 0;
  virtual bool get_time(MYBLOCKCHAIN_TIME *ltime)= 0;
  /**
  ...
  */
  ...
  virtual bool get_date_result(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
  ...
  */
  ...
  /*
    ...
    an item tree. The version is the version where a MyBlockchain function
...
public:
  ...
  */
  ...
  bool get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate);
  bool get_date_result(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate);
  bool get_time(MYBLOCKCHAIN_TIME *ltime);
  ...
  {
    DBUG_ASSERT(field_type() == MYBLOCKCHAIN_TYPE_GEOMETRY);
...
public:
  ...
  enum_field_types field_type() const   { return MYBLOCKCHAIN_TYPE_NULL; }
...
public:
  ...
  */
  ...
  union
  {
    ...
    /*
      ...
      between subsequent calls to myblockchain_stmt_execute).
    */
  ...
  /*
    ...
    For example in case of 'SELECT ?' you'll get MYBLOCKCHAIN_TYPE_STRING both
    in result set and placeholders metadata, no matter what type you will
    supply for this placeholder in myblockchain_stmt_execute.
  */
  ...
  */
  ...
  my_decimal *val_decimal(my_decimal*);
  String *val_str(String*);
  bool get_time(MYBLOCKCHAIN_TIME *tm);
  bool get_date(MYBLOCKCHAIN_TIME *tm, my_time_flags_t fuzzydate);
  type_conversion_status save_in_field(Field *field, bool no_conversions);
  ...
  void set_time(MYBLOCKCHAIN_TIME *tm, timestamp_type type, uint32 max_length_arg);
...
public:
  ...
  enum_field_types field_type() const { return MYBLOCKCHAIN_TYPE_LONGLONG; }
...
public:
  ...
  enum_field_types field_type() const { return MYBLOCKCHAIN_TYPE_NEWDECIMAL; }
  longlong val_int();
  double val_real();
  String *val_str(String*);
...
public:
  ...
  enum_field_types field_type() const { return MYBLOCKCHAIN_TYPE_DOUBLE; }
...
public:
  ...
  */
  ...
  type_conversion_status save_in_field(Field *field, bool no_conversions);
  enum Item_result result_type () const { return STRING_RESULT; }
  enum_field_types field_type() const { return MYBLOCKCHAIN_TYPE_VARCHAR; }
  bool basic_const_item() const { return 1; }
  bool eq(const Item *item, bool binary_cmp) const;
  Item *clone_item() 
  {
...
public:
  ...
  enum_field_types field_type() const { return MYBLOCKCHAIN_TYPE_BLOB; }
};
...
public:
  /**
    ...
    @param    field_type_arg Data type: MYBLOCKCHAIN_TYPE_DATE or MYBLOCKCHAIN_TYPE_DATETIME
...
public:
  ...
  */
  Item_time_with_ref(uint8 decimals_arg, longlong i, Item *ref_arg):
    Item_temporal_with_ref(MYBLOCKCHAIN_TYPE_TIME, decimals_arg, i, ref_arg, 0)
  {
  }
  Item *clone_item();
  longlong val_time_temporal() { return val_int(); }
...
public:
  Item_cache_str(const Item *item) :
    ...
    is_varbinary(item->type() == FIELD_ITEM &&
                 cached_field_type == MYBLOCKCHAIN_TYPE_VARCHAR &&
