...
public:
  /**
    ...
    myblockchaind must exit. So, return value is the same in both cases.
...
private:
  ...
  */
  bool wait_sync_completion(PAGE *p)
  {
    ...
    {
      myblockchain_cond_wait(&p->cond, &LOCK_tc);
    }
    p->waiters--;
