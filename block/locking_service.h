...
#include "my_global.h"
#include "myblockchain/service_locking.h" // enum_locking_service_lock_type
...
*/
int acquire_locking_service_locks(MYBLOCKCHAIN_THD opaque_thd, const char* lock_namespace,
...
*/
int release_locking_service_locks(MYBLOCKCHAIN_THD opaque_thd, const char* lock_namespace);
