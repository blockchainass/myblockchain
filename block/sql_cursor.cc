...
#include "sql_parse.h"                        // myblockchain_execute_command
...
bool myblockchain_open_cursor(THD *thd, Query_result *result,
                       Server_side_cursor **pcursor)
{
  ...
  /*
    ...
    - successful completion of myblockchain_execute_command without
  ...
  */
  ...
  if (result_materialize->materialized_cursor)
  {
    ...
    /*
      ...
      myblockchain_execute_command(), so all tables except from the cursor
  ...
  THD *thd, List<Item> &send_result_set_metadata)
{
  ...
  */
  ...
  /*
    ...
    myblockchain_execute_command() is finished, item_list can not be used for
                                                        ...
                                                        uint flags)
{
  ...
  */
  ...
  /*
    close_thread_tables() will be called in myblockchain_execute_command() which
