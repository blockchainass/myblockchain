...
public:
  PolyLock_mutex(myblockchain_mutex_t *arg): mutex(arg) {}
  void rdlock() { myblockchain_mutex_lock(mutex); }
  void wrlock() { myblockchain_mutex_lock(mutex); }
  void unlock() { myblockchain_mutex_unlock(mutex); }
};
...
public:
  PolyLock_rwlock(myblockchain_rwlock_t *arg): rwlock(arg) {}
  void rdlock() { myblockchain_rwlock_rdlock(rwlock); }
  void wrlock() { myblockchain_rwlock_wrlock(rwlock); }
  void unlock() { myblockchain_rwlock_unlock(rwlock); }
};
