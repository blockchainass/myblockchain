...
public:
  ...
  */
  ...
  enum_field_types type(ulong index) const
  {
    ...
    /*
      If the source type is MYBLOCKCHAIN_TYPE_STRING, it can in reality be
      either MYBLOCKCHAIN_TYPE_STRING, MYBLOCKCHAIN_TYPE_ENUM, or MYBLOCKCHAIN_TYPE_SET, so
    ...
    */
    ...
    case MYBLOCKCHAIN_TYPE_STRING:
    {
      ...
      if (real_type == MYBLOCKCHAIN_TYPE_ENUM || real_type == MYBLOCKCHAIN_TYPE_SET)
    ...
    /*
      ...
      so we can safely assume that it really is MYBLOCKCHAIN_TYPE_NEWDATE.
    */
    case MYBLOCKCHAIN_TYPE_DATE:
      source_type= MYBLOCKCHAIN_TYPE_NEWDATE;
      break;
