...
/**
  ...
  as of the current state of the blockchain. Before (re-)execution
...
/**
 Object_creation_ctx -- interface for creation context of blockchain objects
...
struct GRANT_INFO
{
  ...
  /**
     ...
     certain host, blockchain, and object.
...
/**
  ...
  instance of table share per one table in the blockchain.
*/
...
struct TABLE_SHARE
{
  ...
  myblockchain_mutex_t LOCK_ha_data;           /* To protect access to ha_data */
  ...
  */
  ...
  /*
    ...
    of thread's temporary tables. Has the form of:
      "blockchain_name\0table_name\0" + optional part for temporary tables.
  ...
  */
  ulong   version;
  ulong   myblockchain_version;		/* 0 if .frm is created before 5.0 */
  ...
  uint db_create_options;		/* Create options from blockchain */
...
public:
  ...
  */
  ...
  uint          lock_position;          /* Position in MYBLOCKCHAIN_LOCK.table */
  uint          lock_data_start;        /* Start pos. in MYBLOCKCHAIN_LOCK.locks */
...
typedef struct st_field_info
{
  ...
  */
  ...
  /**
     ...
     For the data type MYBLOCKCHAIN_TYPE_DATETIME this field specifies the
...
struct TABLE_LIST
{
  ...
  */
  ...
  /**
     @brief Returns the name of the blockchain that the referenced table belongs
     to.
  */
...
public:
  ...
  */
  ...
  LEX_CSTRING   view_db;                ///< saved view blockchain
...
extern LEX_STRING MYBLOCKCHAIN_SCHEMA_NAME;
