...
inline bool sql_command_can_be_traced(enum enum_sql_command sql_command)
{
  /*
    ...
    check_prepared_statement() (resp. myblockchain_execute_command() called by
...
void opt_trace_disable_if_no_security_context_access(THD *thd)
{
  ...
  if (!trace->is_started())
  {
    /*
      ...
      (like in: "SET OPTIMIZER_TRACE='ENABLED=ON';USE somedb;" in the 'myblockchain'
...
ST_FIELD_INFO optimizer_trace_info[]=
{
  ...
  {"QUERY", 65535, MYBLOCKCHAIN_TYPE_STRING, 0, false, NULL, SKIP_OPEN_TABLE},
  {"TRACE", 65535, MYBLOCKCHAIN_TYPE_STRING, 0, false, NULL, SKIP_OPEN_TABLE},
  {"MISSING_BYTES_BEYOND_MAX_MEM_SIZE", 20, MYBLOCKCHAIN_TYPE_LONG,
   0, false, NULL, SKIP_OPEN_TABLE},
  {"INSUFFICIENT_PRIVILEGES", 1, MYBLOCKCHAIN_TYPE_TINY,
   0, false, NULL, SKIP_OPEN_TABLE},
...
/*
  ...
  Consider
  myblockchain> set names latin1;
  myblockchain> SELECT 'í', _cp850'í';
  | í | Ý |
