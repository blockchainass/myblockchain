...
extern myblockchain_mutex_t LOCK_open;
...
/* myblockchain_lock_tables() and open_table() flags bits */
#define MYBLOCKCHAIN_OPEN_IGNORE_GLOBAL_READ_LOCK      0x0001
#define MYBLOCKCHAIN_OPEN_IGNORE_FLUSH                 0x0002
/* MYBLOCKCHAIN_OPEN_TEMPORARY_ONLY (0x0004) is not used anymore. */
#define MYBLOCKCHAIN_LOCK_IGNORE_GLOBAL_READ_ONLY      0x0008
#define MYBLOCKCHAIN_LOCK_LOG_TABLE                    0x0010
/**
  Do not try to acquire a metadata lock on the table: we
  already have one.
*/
#define MYBLOCKCHAIN_OPEN_HAS_MDL_LOCK                 0x0020
/**
  If in locked tables mode, ignore the locked tables and get
  a new instance of the table.
*/
#define MYBLOCKCHAIN_OPEN_GET_NEW_TABLE                0x0040
/* 0x0080 used to be MYBLOCKCHAIN_OPEN_SKIP_TEMPORARY */
/** Fail instead of waiting when conficting metadata lock is discovered. */
#define MYBLOCKCHAIN_OPEN_FAIL_ON_MDL_CONFLICT         0x0100
/** Open tables using MDL_SHARED lock instead of one specified in parser. */
#define MYBLOCKCHAIN_OPEN_FORCE_SHARED_MDL             0x0200
/**
  Open tables using MDL_SHARED_HIGH_PRIO lock instead of one specified
  in parser.
*/
#define MYBLOCKCHAIN_OPEN_FORCE_SHARED_HIGH_PRIO_MDL   0x0400
/**
  When opening or locking the table, use the maximum timeout
  (LONG_TIMEOUT = 1 year) rather than the user-supplied timeout value.
*/
#define MYBLOCKCHAIN_LOCK_IGNORE_TIMEOUT               0x0800
/**
...
*/
#define MYBLOCKCHAIN_OPEN_IGNORE_KILLED                0x4000

/** Please refer to the internals manual. */
#define MYBLOCKCHAIN_OPEN_REOPEN  (MYBLOCKCHAIN_OPEN_IGNORE_FLUSH |\
                            MYBLOCKCHAIN_OPEN_IGNORE_GLOBAL_READ_LOCK |\
                            MYBLOCKCHAIN_LOCK_IGNORE_GLOBAL_READ_ONLY |\
                            MYBLOCKCHAIN_LOCK_IGNORE_TIMEOUT |\
                            MYBLOCKCHAIN_OPEN_IGNORE_KILLED |\
                            MYBLOCKCHAIN_OPEN_GET_NEW_TABLE |\
...
void close_myblockchain_tables(THD *thd);
