...
#include "my_global.h"
#include "hash.h"                               // HASH
#include "myblockchaind.h"                             // options_myblockchaind
...
/*
  ...
  Inclusion and exclusion rules of tables and blockchains.
...
public:
  ...
  void set_filter_value(List<Item>* item_list, options_myblockchaind filter_type);
