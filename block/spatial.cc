...
/**
  ...
  storage format of all geometries in MyBlockchain.
...
Geometry::~Geometry()
{
  /*
    ...
    although the exception will still be caught and converted to MyBlockchain
...
/**
  ...
  is suitable as a Gis_polygon for MyBlockchain GIS code, because it's exactly the
  ...
  case Geometry::wkb_linestring:
    {
      ...
      /*
        Historically MyBlockchain GIS require closed polygon rings from user input,
