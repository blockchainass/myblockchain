...
/*
  This file defines the NDB Cluster handler: the interface between MyBlockchain and
  NDB Cluster
*/
...
typedef struct ndb_index_data {
  ...
  /*
    In myblockchaind, keys and rows are stored differently (using KEY_PART_INFO for
...
private:
  ...
  */
  ...
  friend int ndbcluster_drop_blockchain_impl(THD *thd, const char *path);
