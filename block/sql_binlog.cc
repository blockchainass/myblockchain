...
/**
  ...
  Format_description_log_event, as outputted by myblockchainbinlog.  This
...
void myblockchain_client_binlog_statement(THD* thd)
{
  DBUG_ENTER("myblockchain_client_binlog_statement");
