...
#endif
  myblockchain_cond_t COND_cache_status_changed;
...
protected:
  ...
  */
  myblockchain_mutex_t structure_guard_mutex;
  ...
  */
  ...
  /* Remove all queries that uses any of the tables in following blockchain */
