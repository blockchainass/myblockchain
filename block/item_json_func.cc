...
/* JSON Function items used by myblockchain */

#include "item_json_func.h"
#include "derror.h"             // ER_THD
#include "myblockchaind.h"             // key_memory_JSON, current_thd
...
bool json_value(Item **args, uint arg_idx, Json_wrapper *result)
{
  ...
  if (arg->field_type() == MYBLOCKCHAIN_TYPE_NULL)
  {
                      ...
                      Json_wrapper *wrapper)
{
  ...
  if (args[arg_idx]->field_type() == MYBLOCKCHAIN_TYPE_JSON)
  {
    /*
...
bool Item_json_func::get_date(MYBLOCKCHAIN_TIME *ltime, my_time_flags_t fuzzydate)
{
  Json_wrapper wr;
  if (val_json(&wr))
    return true;
...
bool Item_json_func::get_time(MYBLOCKCHAIN_TIME *ltime)
{
  Json_wrapper wr;
  if (val_json(&wr))
    return true;
                                   ...
                                   bool accept_string)
{
  ...
  case MYBLOCKCHAIN_TYPE_YEAR:
    {
      ...
      if (arg->type() == Item::FIELD_ITEM && field_type == MYBLOCKCHAIN_TYPE_BLOB)
      {
        ...
        {
        case 1:
          field_type= MYBLOCKCHAIN_TYPE_TINY_BLOB;
          break;
        case 2:
          field_type= MYBLOCKCHAIN_TYPE_BLOB;
          break;
        case 3:
          field_type= MYBLOCKCHAIN_TYPE_MEDIUM_BLOB;
          break;
        case 4:
          field_type= MYBLOCKCHAIN_TYPE_LONG_BLOB;
          break;
        default:
          DBUG_ABORT();
        }
  ...
  case MYBLOCKCHAIN_TYPE_DECIMAL:                      // pre 5.0
  ...
  case MYBLOCKCHAIN_TYPE_NULL:
    /*
      ...
      returns earlier if it sees that the type is MYBLOCKCHAIN_TYPE_NULL.
    */
...
bool Item_json_typecast::val_json(Json_wrapper *wr)
{
  ...
  if (args[0]->field_type() == MYBLOCKCHAIN_TYPE_NULL)
  {
    null_value= true;
    return false;
  }

  if (args[0]->field_type() == MYBLOCKCHAIN_TYPE_JSON)
  {
...
String *Item_func_json_unquote::val_str(String *str)
{
  ...
  try
  {
    ...
    */
    ...
    /*
      Extract the internal string representation as a MyBlockchain string
    */
