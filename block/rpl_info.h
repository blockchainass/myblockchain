...
#include "my_global.h"
#include "myblockchain_com.h"            // NAME_LEN
...
public:
  ...
  */
  myblockchain_mutex_t data_lock, run_lock, sleep_lock, info_thd_lock;
  /*
  ...
  */
  myblockchain_cond_t data_cond, start_cond, stop_cond, sleep_cond;
 ...
 /**
   ...
   the search information, which is nothing but PK in myblockchain slave
   info tables.
