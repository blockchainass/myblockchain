...
{
  myblockchain_mutex_init(key_mutex_slave_reporting_capability_err_lock,
                                                    ...
                                                    uint error_arg, bool* silent) const
{
  ...
  */
  ...
  error= (error_arg == 0)? thd->get_stmt_da()->myblockchain_errno() : error_arg;
...
{
  myblockchain_mutex_destroy(&err_lock);
}
