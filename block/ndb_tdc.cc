...
/*
  Close all tables in MyBlockchain Server's table definition cache
...
/*
  Close table in MyBlockchain Server's table definition cache
  which aren't in use by any thread

  @param     thd     Thread handle
  @param[in] dbname  Name of blockchain table is in
