...
/*
  ...
  blockchain wide trigger namespace.
*/
...
struct Trg_file_data
{
  ...
  /// List of blockchain collation names.
...
/**
  ...
  @param db_name     Name of blockchain for subject table
...
/**
  ...
  @param [in] db_name        trigger's blockchain name
...
static bool rm_trn_file(const char *db_name, const char *trigger_name)
{
  ...
  return myblockchain_file_delete(key_file_trn, path, MYF(MY_WME));
}
...
/**
  ...
  @param db_name      table's blockchain name
...
static bool rm_trg_file(const char *db_name, const char *table_name)
{
  ...
  return myblockchain_file_delete(key_file_trg, path, MYF(MY_WME));
}
...
/**
  ...
  @param db_name         Old blockchain of subject table
  @param new_db_name         New blockchain of subject table
  ...
  const Trigger *stopper)
{
  ...
  while ((t= it++))
  {
    ...
    // Remove stale .TRN file in case of blockchain upgrade.
      ...
      trg.db_cl_names.is_empty())
  {
    ...
    */
    ...
    lex_string_set(&default_db_cl_name,
                   thd->variables.collation_blockchain->name);
  }
                                   ...
                                   List<Trigger> *triggers)
{
  ...
  {
    myblockchain_file_delete(key_file_trn, trn_file_name.str, MYF(MY_WME));
    return true;
  }
