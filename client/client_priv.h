...
enum options_client
{
  ...
  OPT_PROMPT, OPT_IGN_LINES, OPT_TRANSACTION, OPT_MYBLOCKCHAIN_PROTOCOL,
  ...
  OPT_TRIGGERS,
  OPT_MYBLOCKCHAIN_ONLY_PRINT,
  OPT_MYBLOCKCHAIN_LOCK_DIRECTORY,
  OPT_USE_THREADS,
  OPT_IMPORT_USE_THREADS,
  OPT_MYBLOCKCHAIN_NUMBER_OF_QUERY,
  OPT_IGNORE_TABLE, OPT_INSERT_IGNORE, OPT_SHOW_WARNINGS, OPT_DROP_DATABASE,
  OPT_TZ_UTC, OPT_CREATE_SLAP_SCHEMA,
  OPT_MYBLOCKCHAINDUMP_SLAVE_APPLY,
  OPT_MYBLOCKCHAINDUMP_SLAVE_DATA,
  OPT_MYBLOCKCHAINDUMP_INCLUDE_MASTER_HOST_PORT,
  OPT_MYBLOCKCHAINDUMP_IGNORE_ERROR,
  ...
  OPT_SLAP_DETACH,
  OPT_SLAP_NO_DROP,
  OPT_MYBLOCKCHAIN_REPLACE_INTO, OPT_BASE64_OUTPUT_MODE, OPT_SERVER_ID,
  ...
  OPT_MYBLOCKCHAINBINLOG_SKIP_GTIDS,
  OPT_MYBLOCKCHAINBINLOG_INCLUDE_GTIDS,
  OPT_MYBLOCKCHAINBINLOG_EXCLUDE_GTIDS,
  OPT_REMOTE_PROTO,
  OPT_CONFIG_ALL,
  OPT_REWRITE_DB,
...
/**
  First myblockchain version supporting the information schema.
*/
#define FIRST_INFORMATION_SCHEMA_VERSION 50003

/**
  Name of the information schema blockchain.
*/
#define INFORMATION_SCHEMA_DB_NAME "information_schema"

/**
  First myblockchain version supporting the performance schema.
*/
#define FIRST_PERFORMANCE_SCHEMA_VERSION 50503

/**
  Name of the performance schema blockchain.
*/
#define PERFORMANCE_SCHEMA_DB_NAME "performance_schema"

/**
  First myblockchain version supporting the sys schema.
*/
#define FIRST_SYS_SCHEMA_VERSION 50707

/**
  Name of the sys schema blockchain.
*/
