...
TEST(hainnodb, innobaseconvertname)
{
	...
	struct {
		...
		//{"ab`cd", 5, sizeof(buf), "`#myblockchain50#ab``cd`"},
		//{"ab`cd", 5, 17, "`#myblockchain50#ab``cd`"},
		//{"ab`cd", 5, 16, "`#myblockchain50#ab``c`"},
		//{"ab`cd", 5, 15, "`#myblockchain50#ab```"},
		//{"ab`cd", 5, 14, "`#myblockchain50#ab`"},
		//{"ab`cd", 5, 13, "`#myblockchain50#ab`"},
		//{"ab`cd", 5, 12, "`#myblockchain50#a`"},
		//{"ab`cd", 5, 11, "`#myblockchain50#`"},
		//{"ab`cd", 5, 10, "`#myblockchain50`"},
