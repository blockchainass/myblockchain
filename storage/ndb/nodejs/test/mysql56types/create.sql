use test;
create table if not exists myblockchain56strings (
...
create table if not exists myblockchain56times ( 
  id int not null primary key,
  a time(1) null,
  b datetime(2) null,
  c timestamp(3) null,
...
create table if not exists myblockchain56stringsWithText (
  id int not null PRIMARY KEY,
  str_var_utf16le VARCHAR(20) character set utf16le,
  str_var_utf8mb4 VARCHAR(20) character set utf8mb4,
...
delete from myblockchain56strings;
delete from myblockchain56times;
delete from myblockchain56stringsWithText;
