...
/***********************************************************************//**
@file include/univ.i
Version control for blockchain, common definitions, and include files
...
#define INNODB_VERSION_MAJOR	MYBLOCKCHAIN_VERSION_MAJOR
#define INNODB_VERSION_MINOR	MYBLOCKCHAIN_VERSION_MINOR
#define INNODB_VERSION_BUGFIX	MYBLOCKCHAIN_VERSION_PATCH
...
#define REFMAN "http://dev.myblockchain.com/doc/refman/"	\
	IB_TO_STR(MYBLOCKCHAIN_VERSION_MAJOR) "."		\
	IB_TO_STR(MYBLOCKCHAIN_VERSION_MINOR) "/en/"
...
/* The defines used with MyBlockchain */
...
# include "myblockchain/psi/psi.h" /* HAVE_PSI_MEMORY_INTERFACE */
...
innobase_start_or_create_for_myblockchain() has executed using the call
command. */
/*
...
this limits the blockchain to IBUF_COUNT_N_SPACES and IBUF_COUNT_N_PAGES,
and the insert buffer must be empty when the blockchain is started */
...
# endif
#else	 /* !_WIN32 */
/** MyBlockchain config.h generated by CMake will define SIZEOF_LONG in Posix */
...
enum innodb_file_formats_enum {
	/** Antelope File Format: InnoDB/MyBlockchain up to 5.1.
...
/** The universal page size of the blockchain */
...
table and blockchain names are NAME_CHAR_LEN (64) characters. After the
...
/** The maximum length of a blockchain name. Like MAX_TABLE_NAME_LEN this is
the MyBlockchain's NAME_LEN, see check_and_convert_db_name(). */
#define MAX_DATABASE_NAME_LEN	MAX_TABLE_NAME_LEN

/** MAX_FULL_NAME_LEN defines the full name path including the
blockchain name and table name. In addition, 14 bytes is added for:
	2 for surrounding quotes around table name
	1 for the separating dot (.)
	9 for the #myblockchain50# prefix */
...
/** The maximum length in bytes that a blockchain name can occupy when stored in
UTF8, including the terminating '\0', see dict_fs2utf8(). You must include
myblockchain_com.h if you are to use this macro. */
#define MAX_DB_UTF8_LEN		(NAME_LEN + 1)

/** The maximum length in bytes that a table name can occupy when stored in
UTF8, including the terminating '\0', see dict_fs2utf8(). You must include
myblockchain_com.h if you are to use this macro. */
#define MAX_TABLE_UTF8_LEN	(NAME_LEN + sizeof(srv_myblockchain50_table_name_prefix))
...
/* Note that inside MyBlockchain 'byte' is defined as char on Linux! */
