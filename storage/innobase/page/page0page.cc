	...
	mtr_t*		mtr)	/*!< in/out: mini-transaction, or NULL */
{
	...
	during a blockchain recovery we assume that the max trx id of every
	...
	mtr_t*		mtr)	/*!< in: mtr */
{
	...
	if (recv_recovery_is_on()) {
		...
		replay it exactly. Since MyBlockchain 5.6.11, we should be
		...
		generated by an older version of MyBlockchain. */
