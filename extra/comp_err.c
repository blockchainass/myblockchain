...
static char *HEADERFILE= (char*) "myblockchaind_error.h";
static char *NAMEFILE= (char*) "myblockchaind_ername.h";
...
static struct my_option my_long_options[]=
{
  ...
  {"header_file", 'H', "myblockchaind_error.h file ", &HEADERFILE,
   &HEADERFILE, 0, GET_STR, REQUIRED_ARG, 0, 0, 0, 0, 0, 0},
  {"name_file", 'N', "myblockchaind_ername.h file ", &NAMEFILE,
...
#if MYBLOCKCHAIN_VERSION_ID >= 50100 && MYBLOCKCHAIN_VERSION_ID < 50500
/* Number of error messages in 5.1 - do not change this number! */
#define MYBLOCKCHAIN_OLD_GA_ERROR_MESSAGE_COUNT 641
#elif MYBLOCKCHAIN_VERSION_ID >= 50500 && MYBLOCKCHAIN_VERSION_ID < 50600
/* Number of error messages in 5.5 - do not change this number! */
#define MYBLOCKCHAIN_OLD_GA_ERROR_MESSAGE_COUNT 728
#endif
#if MYBLOCKCHAIN_OLD_GA_ERROR_MESSAGE_COUNT
    if (row_count != MYBLOCKCHAIN_OLD_GA_ERROR_MESSAGE_COUNT)
    {
      ...
      fprintf(stderr, "Expected %u messages, found %u.\n",
              MYBLOCKCHAIN_OLD_GA_ERROR_MESSAGE_COUNT, row_count);
      DBUG_RETURN(1);
    }
#endif
...
static int create_header_files(struct errors *error_head)
{
  ...
  fprintf(er_definef, "#ifndef MYBLOCKCHAIND_ERROR_INCLUDED\n");
  fprintf(er_definef, "#define MYBLOCKCHAIND_ERROR_INCLUDED\n\n");
  ...
  */
  ...
  {
    /*
       generating myblockchaind_error.h
  ...
  /* finishing off with myblockchaind_error.h */
