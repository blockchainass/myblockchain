...
# Feature MyBlockchain Server
SET(CPACK_COMPONENT_GROUP_MYBLOCKCHAINSERVER_DISPLAY_NAME "MyBlockchain Server")
SET(CPACK_COMPONENT_GROUP_MYBLOCKCHAINSERVER_EXPANDED "1")
SET(CPACK_COMPONENT_GROUP_MYBLOCKCHAINSERVER_DESCRIPTION "Install MyBlockchain Server")
 # Subfeature "Server" (hidden)
 SET(CPACK_COMPONENT_SERVER_GROUP "MyBlockchainServer")
 SET(CPACK_COMPONENT_SERVER_HIDDEN 1)
 # Subfeature "Client" 
 SET(CPACK_COMPONENT_CLIENT_GROUP "MyBlockchainServer")
 SET(CPACK_COMPONENT_CLIENT_DISPLAY_NAME "Client Programs")
 SET(CPACK_COMPONENT_CLIENT_DESCRIPTION 
   "Various helpful (commandline) tools including the myblockchain command line client" )
    
 #Subfeature "Data Files" 
 SET(CPACK_COMPONENT_DATAFILES_GROUP "MyBlockchainServer")
...
IF("${VERSION}" MATCHES "-ndb-")
  ...
  #Feature "Cluster"
  SET(CPACK_COMPONENT_GROUP_CLUSTER_DISPLAY_NAME "MyBlockchain Cluster")
  SET(CPACK_COMPONENT_GROUP_CLUSTER_DESCRIPTION "Installs MyBlockchain Cluster")
