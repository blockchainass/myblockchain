...
#include <myblockchain/plugin_auth_common.h> // for MYBLOCKCHAIN_PLUGIN_VIO
...
/**
  Convenience wrapper around MYBLOCKCHAIN_PLUGIN_VIO object providing basic
  read/write operations.
*/

class Connection
{
  MYBLOCKCHAIN_PLUGIN_VIO *m_vio;    ///< Pointer to @c MYBLOCKCHAIN_PLUGIN_VIO structure.
...
public:
  ...
  Connection(MYBLOCKCHAIN_PLUGIN_VIO *vio);
