...
#include <myblockchain.h> // for MYBLOCKCHAIN structure
...
/**
  ...
  @param[in]  vio    pointer to @c MYBLOCKCHAIN_PLUGIN_VIO instance to be used
                     for communication with the server
  @param[in]  myblockchain  pointer to a MyBlockchain connection for which we authenticate
...
int win_auth_handshake_client(MYBLOCKCHAIN_PLUGIN_VIO *vio, MYBLOCKCHAIN *myblockchain)
{
  ...
  */
  ...
  ERROR_LOG(INFO, ("Authentication handshake for account %s", myblockchain->user));
