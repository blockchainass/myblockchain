...
/**
  ...
  table definition consists of blockchain name, table name, and column
  definitions.
  ...
  <tr>
    ...
    <td>The name of the blockchain in which the table resides.  The name
    ...
    the blockchain name, followed by a terminating 0 byte.  (Note the
  ...
  <tr>
    <td>table_name</td>
    <td>one byte string length, followed by null-terminated string</td>
    <td>The name of the table, encoded the same way as the blockchain
    name above.</td>
  </tr>
  ...
  <tr>
    ...
    enumeration type enum_field_types defined in myblockchain_com.h.  The
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_DECIMAL</td><td>0</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_TINY</td><td>1</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_SHORT</td><td>2</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_LONG</td><td>3</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_FLOAT</td><td>4</td>
    <td>1 byte</td>
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_DOUBLE</td><td>5</td>
    <td>1 byte</td>
    <td>1 byte unsigned integer, representing the "pack_length", which
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_NULL</td><td>6</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_TIMESTAMP</td><td>7</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_LONGLONG</td><td>8</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_INT24</td><td>9</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_DATE</td><td>10</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_TIME</td><td>11</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_DATETIME</td><td>12</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_YEAR</td><td>13</td>
    <td>0</td>
    <td>No column metadata.</td>
  </tr>

  <tr>
    <td><i>MYBLOCKCHAIN_TYPE_NEWDATE</i></td><td><i>14</i></td>
    <td>&ndash;</td>
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_VARCHAR</td><td>15</td>
    <td>2 bytes</td>
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_BIT</td><td>16</td>
    <td>2 bytes</td>
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_NEWDECIMAL</td><td>246</td>
    <td>2 bytes</td>
  ...
  <tr>
    <td><i>MYBLOCKCHAIN_TYPE_ENUM</i></td><td><i>247</i></td>
    <td>&ndash;</td>
    <td><i>This enumeration value is only used internally and cannot
    exist in a binlog.</i></td>
  </tr>
  ...
  <tr>
    <td><i>MYBLOCKCHAIN_TYPE_SET</i></td><td><i>248</i></td>
    <td>&ndash;</td>
    <td><i>This enumeration value is only used internally and cannot
    exist in a binlog.</i></td>
  </tr>
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_TINY_BLOB</td><td>249</td>
    <td>&ndash;</td>
    <td><i>This enumeration value is only used internally and cannot
    exist in a binlog.</i></td>
  </tr>
  ...
  <tr>
    <td><i>MYBLOCKCHAIN_TYPE_MEDIUM_BLOB</i></td><td><i>250</i></td>
    <td>&ndash;</td>
    <td><i>This enumeration value is only used internally and cannot
    exist in a binlog.</i></td>
  </tr>
  ...
  <tr>
    <td><i>MYBLOCKCHAIN_TYPE_LONG_BLOB</i></td><td><i>251</i></td>
    <td>&ndash;</td>
    <td><i>This enumeration value is only used internally and cannot
    exist in a binlog.</i></td>
  </tr>
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_BLOB</td><td>252</td>
    <td>1 byte</td>
  ...
  <tr>
    <td>MYBLOCKCHAIN_TYPE_VAR_STRING</td><td>253</td>
    <td>2 bytes</td>
    <td>This is used to store both strings and enumeration values.
    The first byte is a enumeration value storing the <i>real
    type</i>, which may be either MYBLOCKCHAIN_TYPE_VAR_STRING or
    MYBLOCKCHAIN_TYPE_ENUM.  The second byte is a 1 byte unsigned integer
    representing the field size, i.e., the number of bytes needed to
    store the length of the string.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_STRING</td><td>254</td>
    <td>2 bytes</td>
    <td>The first byte is always MYBLOCKCHAIN_TYPE_VAR_STRING (i.e., 253).
    The second byte is the field size, i.e., the number of bytes in
    the representation of size of the string: 3 or 4.</td>
  </tr>

  <tr>
    <td>MYBLOCKCHAIN_TYPE_GEOMETRY</td><td>255</td>
    <td>1 byte</td>
    <td>The pack length, i.e., the number of bytes needed to represent
...
/**
  ...
  comments by SHOW BINLOG EVENTS query, or myblockchainbinlog client when the
