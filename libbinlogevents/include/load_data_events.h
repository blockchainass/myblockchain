...
/**
  ...
  <tr>
    ...
    When MyBlockchain writes a Load_event, it uses the new format if at
  ...
  */
  ...
  /**
    ...
    @note Since Load_event event coming from the binary log
          ...
          Load_event object which is used in myblockchain_load() to
...
protected:
  /**
    This constructor is used by the MyBlockchain server.
  */
...
public:
  ...
  uint32_t file_id;
  /**
    'db' is filled when the event is created in myblockchain_load() (the
