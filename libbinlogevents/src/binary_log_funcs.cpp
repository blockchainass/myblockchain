...
max_display_length_for_field(enum_field_types sql_type, unsigned int metadata)
{
  ...
  case MYBLOCKCHAIN_TYPE_STRING:
  {
    ...
    if (type == MYBLOCKCHAIN_TYPE_SET || type == MYBLOCKCHAIN_TYPE_ENUM)
  ...
  case MYBLOCKCHAIN_TYPE_BLOB:
    /*
      ...
      blobs are of type MYBLOCKCHAIN_TYPE_BLOB. In that case, we have to look
                         ...
                         unsigned int metadata)
{
  ...
  /*
    ...
    both are mapped to type MYBLOCKCHAIN_TYPE_STRING and their real types
  ...
  case MYBLOCKCHAIN_TYPE_STRING:
  {
    ...
    else
    {
      /*
        ...
        one or two bytes.
      */
      length= max_display_length_for_field(MYBLOCKCHAIN_TYPE_STRING, metadata) > 255 ? 2 : 1;
